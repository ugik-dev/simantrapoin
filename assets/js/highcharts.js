...
(function (S, M) {
	...
	M(
		...
		function (c, e) {
			...
			q(P.prototype, {
				...
				setTextPath: function (a, b) {
					...
					if (a && b && b.enabled) {
						...
						z ||
							((this.textPathWrapper = z = this.renderer.createElement(
								"textPath"
							)),
							(g = !0));
						var t = z.element;
			...
			P.prototype.translateXSetter = P.prototype.translateYSetter = P.prototype.rotationSetter = P.prototype.verticalAlignSetter = P.prototype.rotationOriginXSetter = P.prototype.rotationOriginYSetter = P.prototype.scaleXSetter = P.prototype.scaleYSetter = P.prototype.matrixSetter = function (
				a,
				b
			) {
				this[b] = a;
			...
			B(e.prototype, {
				...
				drawCrosshair: function (a, b) {
					...
					if (this.crosshair && !1 !== (q(b) || !f)) {
						...
						c ||
							((this.cross = c = this.chart.renderer
								.path()
								.addClass(
			...
			c.PlotLineOrBand.prototype = {
				render: function () {
					...
					(t = r.plotLinesAndBandsGroups[z]) ||
						(r.plotLinesAndBandsGroups[z] = t = n
							.g("plot-" + z)
							.attr(E)
							.add());
			...
			e.prototype.applyFixed = function () {
				...
				H
					? ((this.fixedDiv = c.createElement(
					  ...
					  (this.fixedRenderer = e = new c.Renderer(
							this.fixedDiv,
							this.chartWidth,
							this.chartHeight
					  )),
				...
				{ softThreshold: !1, threshold: 0 },
				{
					...
					getGraphPath: function (c) {
						...
						for (w = 0; w < c.length; w++) {
							B ||
								(c[w].leftCliff = c[w].rightCliff = c[w].leftNull = c[
									w
								].rightNull = void 0);
							var d = c[w].isNull;
							...
							if (v(a.plotY) && null !== a.y) {
								...
								c.enabledDataSorting &&
									(a.startXPos = c.xAxis.reversed
										...
										: c.xAxis.width);
								d ||
									((a.graphic = d = u[a.shapeType](b).add(
										a.group || c.group
									)) &&
										c.enabledDataSorting &&
										e.hasRendered &&
							...
							if (a && l) {
								...
								if (A)
									if (u) u[b ? "animate" : "attr"]({ x: A.x, y: A.y });
										...
										d &&
											((c.stateMarkerGraphic = u = y.renderer
			...
			I(a.prototype, {
				...
				setVisible: function (a, b) {
					var c = this,
						...
						h = c.visible;
					var k = (c.visible = a = c.options.visible = c.userOptions.visible =

	...
	$.extend($.jgrid, {
		...
		edit: {
			...
			msg: {
				...
				url:
					"não é uma URL válida. Prefixo obrigatório ('http://' or 'https://')",
				...
				customfcheck:
					"Função customizada deve estar presente em caso de validação customizada!",
			},
		},
		view: {

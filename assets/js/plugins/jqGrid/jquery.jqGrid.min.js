		...
		parseDate: function (e, f, c, d) {
				...
				if (isNaN(f - 0) || "u" !== String(e).toLowerCase())
					if (f.constructor === Date) h = f;
						...
						for (n = e.length; k < n; k++)
							"M" === e[k] &&
								((l = b.inArray(f[k], d.monthNames)),
								-1 !== l && 12 > l && ((f[k] = l + 1), (g.m = f[k]))),
								"F" === e[k] &&
									((l = b.inArray(f[k], d.monthNames, 12)),
									-1 !== l && 11 < l && ((f[k] = l + 1 - 12), (g.m = f[k]))),
								"a" === e[k] &&
			...
			var r = h.getDay(),
				...
				G = {
					...
					O:
						(0 < l ? "-" : "+") +
						a(100 * Math.floor(Math.abs(l) / 60) + (Math.abs(l) % 60), 4),
					P: "?",
					T: (
						String(h).match(
			...
			return new (function (e, c) {
				...
				this._getGroup = function (a, c, e, l, g) {
					...
					b.each(d._getOrder(a, c, e, l, g), function (a, e) {
						...
						null == m && (m = "");
						d._equals(k, m) ||
							((k = m), null !== h && f.push(h), (h = d._group(c, m)));
						h.items.push(e);
					});
					null !== h && f.push(h);
					return f;
				...
				this.startsWith = function (a, c) {
					...
					G
						...
						: (null != c &&
								(e = g ? b.trim(c.toString()).length : c.toString().length),
						  d._append(
								d._getStr("this") +
									".substr(0," +
									e +
									") == " +
									d._getStr('"' + d._toStr(a) + '"')
						  ));
				...
				this.contains = function (a, b) {
					G
						...
						: d._append(
								d._getStr("this") + '.indexOf("' + d._toStr(a) + '",0) > -1'
						  );
			...
			if (!this.grid) {
				var d = b.extend(
					...
					c = {
						...
						dragStart: function (c, e, g) {
							...
							this.curGbox = b(
								"#rs_m" + b.jgrid.jqID(d.id),
								"#gbox_" + b.jgrid.jqID(d.id)
							);
							this.curGbox.css({
								display: "block",
								left: e.clientX - f,
						...
						dragEnd: function () {
							...
							if (this.resizing) {
								...
								0 < this.footers.length &&
									(this.footers[c].style.width = e + "px");
								!0 === d.forceFit
									? ((e =
											this.headers[c + d.nv].newWidth ||
											this.headers[c + d.nv].width),
									  (this.headers[c + d.nv].width = e),
									  (this.headers[c + d.nv].el.style.width = e + "px"),
									  (this.cols[c + d.nv].style.width = e + "px"),
									  0 < this.footers.length &&
											(this.footers[c + d.nv].style.width = e + "px"),
				...
				if ("TABLE" !== this.tagName.toUpperCase())
					...
					if (this.p.colNames.length !== this.p.colModel.length)
						...
						var r = function (a, b) {
							...
							x = function (c, d, e, f, g) {
								...
								void 0 !== h.formatter
									? ((c =
											"" !== String(a.p.idPrefix)
												? b.jgrid.stripPref(a.p.idPrefix, c)
												: c),
							...
							K = function (c, d, e, f, g) {
								var h = new Date(),
									l =
										("local" !== a.p.datatype && a.p.loadonce) ||
										"xmlstring" === a.p.datatype,
									k = a.p.xmlReader,
								...
								if (b.isXMLDoc(c)) {
									...
									var n = b(a),
										...
										ia;
									!0 === a.p.subGrid &&
										((z = 1), (x = b.jgrid.getMethod("addSubGridCell")));
									...
									b.isFunction(k.userdata)
										...
										: b.jgrid.getXmlData(c, k.userdata, !0).each(function () {
												a.p.userData[this.getAttribute("name")] = b(
													this
												).text();
										  });
									...
									if (c && S) {
										...
										var F = !1,
											J;
										a.p.grouping &&
											((F = !0 === a.p.groupingView.groupCollapse),
									...
									a.p.userDataOnFooter &&
										n.jqGrid("footerData", "set", a.p.userData, !0);
								...
								if (c) {
									...
									v =
										!1 === a.p.keyIndex
											...
											: a.p.keyIndex;
									d.repeatitems ||
										((q = k), 0 < q.length && !isNaN(v) && (v = a.p.keyName));
									...
									var N = b.isFunction(a.p.afterInsertRow),
										...
										O;
									a.p.grouping &&
										((Q = !0 === a.p.groupingView.groupCollapse),
									...
									for (; A < c; ) {
										...
										void 0 === s &&
											("number" === typeof v &&
												...
												(s = b.jgrid.getAccessor(
													g,
													a.p.colModel[v + u + z + t].name
												)),
											void 0 === s &&
												((s = F + A),
												0 === q.length &&
													d.cell &&
													((C = b.jgrid.getAccessor(g, d.cell) || g),
										...
										!1 === a.p.gridview &&
											(b("#" + b.jgrid.jqID(a.p.id) + " tbody:first").append(
												L.join("")
											),
									...
									a.p.treeANode = -1;
									a.p.userDataOnFooter &&
										m.jqGrid("footerData", "set", a.p.userData, !0);
									...
									if (l) {
										for (; n < c && B[n]; ) {
											...
											if (g) {
												...
												for (p = 0; p < y.length; p++)
													w[
														a.p.colModel[p + u + z + t].name
													] = b.jgrid.getAccessor(g, y[p]);
												w._id_ = b.jgrid.stripPref(a.p.idPrefix, s);
									...
									b.each(a.p.colModel, function () {
										...
										a.p.multiSort
											? this.lso &&
											  ...
											  e.push(c[c.length - 1]))
											: g ||
											  (this.index !== a.p.sortname &&
													this.name !== a.p.sortname) ||
											  ((d = this.name), (g = !0));
									});
									if (a.p.treeGrid)
										b(a).jqGrid(
										...
										var z = u.select(),
											...
											v = {};
										if (
											(a.p.search || a.p.resetsearch) &&
											a.p.grouping &&
											a.p.groupingView._locgr
										) {
														...
														b.extend(
															{
																...
																error: function (d, e, f) {
																	b.isFunction(a.p.loadError) &&
																		a.p.loadError.call(a, d, e, f);
																	1 === c && T();
																},
																beforeSend: function (c, d) {
																	var e = !0;
																	b.isFunction(a.p.loadBeforeSend) &&
																		(e = a.p.loadBeforeSend.call(a, c, d));
																	void 0 === e && (e = !0);
																	if (!1 === e) return !1;
																	P();
																},
							...
							ha = function (c) {
								...
								if (a.p.frozenColumns && a.p.id + "_frozen")
									b("#cb_" + b.jgrid.jqID(a.p.id), a.grid.fhDiv)[
										a.p.useProp ? "prop" : "attr"
									]("checked", c);
							},
							qa = function (c, e) {
								...
								b(".ui-pg-selbox", "#" + l).bind("change", function () {
									...
									a.p.page =
										Math.round(
											(a.p.rowNum * (a.p.page - 1)) / this.value - 0.5
										) + 1;
									a.p.rowNum = this.value;
									a.p.pager && b(".ui-pg-selbox", a.p.pager).val(this.value);
									a.p.toppager &&
										b(".ui-pg-selbox", a.p.toppager).val(this.value);
									Q();
									return !1;
								});
								!0 === a.p.pgbuttons &&
								...
								if (a.p.colModel[d].sortable && !(0 < a.p.savedRow.length)) {
									e ||
										(a.p.lastsort === d
											...
											: (a.p.sortorder =
													a.p.colModel[d].firstsortorder || "asc"),
										(a.p.page = 1));
									if (a.p.multiSort) wa(d, f);
										...
										b("span.ui-icon-" + a.p.sortorder, f).removeClass(
											"ui-state-disabled"
										);
										...
										a.p.viewsortcols[0] ||
											a.p.lastsort === d ||
											(a.p.frozenColumns &&
												a.grid.fhDiv.find("span.s-ico").hide(),
											b("span.s-ico", e).hide(),
											b("span.s-ico", f).show());
									...
									"stop" ===
									b(a).triggerHandler("jqGridSortCol", [
										a.p.sortname,
										d,
										a.p.sortorder,
									])
										? (a.p.lastsort = d)
										: b.isFunction(a.p.onSortCol) &&
										  "stop" ===
												a.p.onSortCol.call(a, a.p.sortname, d, a.p.sortorder)
										? (a.p.lastsort = d)
										: ("local" === a.p.datatype
										  ...
										  a.p.subGrid &&
												"local" === a.p.datatype &&
												b("td.sgexpanded", "#" + b.jgrid.jqID(a.p.id)).each(
													function () {
						...
						this.p.id = this.id;
						-1 === b.inArray(a.p.multikey, ["shiftKey", "altKey", "ctrlKey"]) &&
							(a.p.multikey = !1);
						a.p.keyIndex = !1;
						a.p.keyName = !1;
						for (g = 0; g < a.p.colModel.length; g++)
							(a.p.colModel[g] = b.extend(
								!0,
								{},
								a.p.cmTemplate,
						...
						for (g = 0; g < this.p.colNames.length; g++)
							(F = a.p.headertitles
								...
								(a.p.colModel[g].width = a.p.colModel[g].width
									...
									: 150),
								"boolean" !== typeof a.p.colModel[g].title &&
									(a.p.colModel[g].title = !0),
								(a.p.colModel[g].lso = ""),
						...
						if (this.p.multiselect) {
							...
							b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function () {
								...
								this.checked
									? (b(a.rows).each(function (d) {
											0 < d &&
												...
												)[a.p.useProp ? "prop" : "attr"]("checked", !0),
												b(this)
												...
												c &&
													...
													b("#" + b.jgrid.jqID(this.id), a.grid.fbDiv).addClass(
														"ui-state-highlight"
													)));
									  }),
									  (ca = !0),
											...
											0 < d &&
												...
												(b(
													"#jqg_" +
														...
														"_" +
														b.jgrid.jqID(this.id)
												)[a.p.useProp ? "prop" : "attr"]("checked", !1),
												b(this)
								...
								b.isFunction(a.p.onSelectAll) &&
									a.p.onSelectAll.call(a, ca ? a.p.selarrrow : la, ca);
							});
						}
						!0 === a.p.autowidth &&
							((D = b(m).innerWidth()), (a.p.width = 0 < D ? D : "nw"));
						(function () {
							var d = 0,
							...
							b.each(a.p.colModel, function () {
								...
								!1 === this.hidden &&
									((d += k + e), this.fixed ? (p += k + e) : g++);
							});
							isNaN(a.p.width) &&
								(a.p.width =
									d + (!1 !== a.p.shrinkToFit || isNaN(a.p.height) ? 0 : h));
							c.width = a.p.width;
							a.p.tblwidth = d;
							!1 === a.p.shrinkToFit &&
								!0 === a.p.forceFit &&
							...
							!0 === a.p.shrinkToFit &&
								...
								b.each(a.p.colModel, function (b) {
									!1 !== this.hidden ||
										this.fixed ||
										((this.width = k = Math.round(
											(n * this.width) / (a.p.tblwidth - e * g - p)
										)),
										(d += k),
										(f = b));
								}),
								...
								m
									? c.width - p - (d + e * g) !== h &&
									  (q = c.width - p - (d + e * g) - h)
									: m ||
									  1 === Math.abs(c.width - p - (d + e * g)) ||
									  (q = c.width - p - (d + e * g)),
								(a.p.colModel[f].width += q),
								(a.p.tblwidth = d + q + e * g + p),
								a.p.tblwidth > a.p.width &&
									((a.p.colModel[f].width -=
										a.p.tblwidth - parseInt(a.p.width, 10)),
									(a.p.tblwidth = a.p.width)));
						})();
						b(m)
						...
						b("th", k)
							.each(function (d) {
								...
								void 0 === a.p.colModel[d].resizable &&
									(a.p.colModel[d].resizable = !0);
								...
								fa = null;
								var e = "";
								a.p.colModel[d].hidden &&
									(b(this).css("display", "none"), (e = "display:none;"));
								da +=
									...
									(a.p.multiSort
										? a.p.viewsortcols[0]
											? (b("div span.s-ico", this).show(),
											  a.p.colModel[d].lso &&
													b(
														"div span.ui-icon-" + a.p.colModel[d].lso,
														this
										...
										? (b("div span.s-ico", this).show(),
										  d === a.p.lastsort &&
												b(
													"div span.ui-icon-" + a.p.sortorder,
													this
												).removeClass("ui-state-disabled"))
										: d === a.p.lastsort &&
										  (b("div span.s-ico", this).show(),
										  b("div span.ui-icon-" + a.p.sortorder, this).removeClass(
												"ui-state-disabled"
										  )));
								a.p.footerrow &&
									(V +=
							...
							.mousedown(function (d) {
								if (
									1 === b(d.target).closest("th>span.ui-jqgrid-resize").length
								) {
									var e = sa(this);
									if (!0 === a.p.forceFit) {
										var g = a.p,
						...
						!1 === a.p.cellEdit &&
							...
							b(a)
								.bind("mouseover", function (a) {
									...
									"ui-subgrid" !== b(t).attr("class") &&
										b(t).addClass("ui-state-hover");
								})
						...
						b(a)
							...
							.click(function (c) {
								...
								if (
									...
									(
										b(y, a).closest("table.ui-jqgrid-btable").attr("id") || ""
									).replace("_frozen", "") !== a.id
								)
									return this;
								var d = b(y).hasClass("cbox"),
									e = b(a).triggerHandler("jqGridBeforeSelectRow", [
										t[0].id,
										c,
									]);
								(e = !1 === e || "stop" === e ? !1 : !0) &&
								...
								if (
									...
									if (
										...
										b.isFunction(a.p.onCellSelect) &&
											a.p.onCellSelect.call(a, B, N, ma, c),
										!0 === a.p.cellEdit)
									)
										...
										c[a.p.multikey]
											...
											: a.p.multiselect &&
											  d &&
											  ((d = b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + B).is(
													":checked"
											  )),
											  b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + B)[
													a.p.useProp ? "prop" : "attr"
											  ]("checked", d));
									else {
										if (a.p.multiselect && a.p.multiboxonly && !d) {
											...
											b(a.p.selarrrow).each(function (c, d) {
												...
												b(
													"#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(d)
												)[a.p.useProp ? "prop" : "attr"]("checked", !1);
												f &&
													(b(
														"#" + b.jgrid.jqID(d),
							...
							.dblclick(function (c) {
								...
								0 !== b(t).length &&
									...
									b.isFunction(a.p.ondblClickRow) &&
										a.p.ondblClickRow.call(a, b(t).attr("id"), B, N, c));
							})
							.bind("contextmenu", function (c) {
								...
								0 !== b(t).length &&
									(a.p.multiselect ||
										b(a).jqGrid("setSelection", t[0].id, !0, c),
									(B = t[0].rowIndex),
									(N = b.jgrid.getCellIndex(y)),
									...
									b.isFunction(a.p.onRightClickRow) &&
										a.p.onRightClickRow.call(a, b(t).attr("id"), B, N, c));
							});
						c.bDiv = document.createElement("div");
						n &&
							"auto" === String(a.p.height).toLowerCase() &&
							(a.p.height = "100%");
						b(c.bDiv)
							.append(
								b(
									'<div style="position:relative;' +
										(n && 8 > b.jgrid.msiever() ? "height:0.01%;" : "") +
										'"></div>'
								)
									.append("<div></div>")
									.append(this)
						...
						b(c.cDiv)
							.append(na)
							.append(
								"<span class='ui-jqgrid-title'>" + a.p.caption + "</span>"
							)
							.addClass(
						...
						a.p.footerrow &&
							...
							a.p.rownumbers &&
								(c.footers[0].className = "ui-state-default jqgrid-rownum"),
							J && b(c.sDiv).hide());
						g = null;
						if (a.p.caption) {
							var ya = a.p.datatype;
							!0 === a.p.hidegrid &&
								(b(".ui-jqgrid-titlebar-close", c.cDiv).click(function (d) {
									...
									"visible" === a.p.gridstate
										? b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp(
												"fast",
												function () {
													f--;
													0 === f &&
														...
														b("#gbox_" + b.jgrid.jqID(a.p.id)).hasClass(
															"ui-resizable"
														) &&
															b(
																".ui-resizable-handle",
																"#gbox_" + b.jgrid.jqID(a.p.id)
															).hide(),
														...
														e &&
															(J ||
																a.p.onHeaderClick.call(a, a.p.gridstate, d)));
												}
										  )
										: "hidden" === a.p.gridstate &&
										  b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown(
												"fast",
												function () {
													f--;
													0 === f &&
						...
						a.updatepager = function (c, d) {
							...
							if (
								...
								(m = b.jgrid.formatter.integer || {}),
									(e = r(a.p.page)),
									(g = r(a.p.lastpage)),
									b(".selbox", n)[this.p.useProp ? "prop" : "attr"](
										"disabled",
										!1
									),
									!0 === a.p.pginput &&
										...
										b(h).html(
											b.fmatter
												? b.fmatter.util.NumberFormat(a.p.lastpage, m)
												: a.p.lastpage
										)),
									a.p.viewrecords &&
										(0 === a.p.reccount
											...
											: ((h = f + 1),
											  ...
											  b(".ui-paging-info", n).html(
													b.jgrid.format(a.p.recordtext, h, k, l)
											  ))),
									!0 === a.p.pgbuttons &&
										(0 >= e && (e = g = 0),
										1 === e || 0 === e
											...
											: (b("#first" + p + ", #prev" + p).removeClass(
											  ...
											  a.p.toppager &&
													b("#first_t" + q + ", #prev_t" + q).removeClass(
														"ui-state-disabled"
													)),
										e === g || 0 === e
											? (b("#next" + p + ", #last" + p)
											...
											: (b("#next" + p + ", #last" + p).removeClass(
											  ...
											  a.p.toppager &&
													b("#next_t" + q + ", #last_t" + q).removeClass(
														"ui-state-disabled"
													)));
							!0 === c &&
								!0 === a.p.rownumbers &&
	...
	b.jgrid.extend({
					...
					!(a = b(this).jqGrid("getGridRowById", e)) ||
						...
						this.p.multiselect
							? (this.setHeadCheckBox(!1),
							  ...
							  b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(a.id))[
									this.p.useProp ? "prop" : "attr"
							  ]("checked", d),
							  k &&
									(-1 === g
										? b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(k)).addClass(
												"ui-state-highlight"
										  )
										: b(
												"#" + b.jgrid.jqID(e),
									...
									b(
										"#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(e),
										"#" + b.jgrid.jqID(k)
									)[this.p.useProp ? "prop" : "attr"]("checked", d)),
							  f &&
									(b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]),
									this.p.onSelectRow &&
										this.p.onSelectRow.call(this, a.id, d, c)))
							: "ui-subgrid" !== a.className &&
							  (this.p.selrow !== a.id
		...
		resetSelection: function (e) {
			return this.each(function () {
				...
				if (void 0 !== e) {
					...
					if (f.p.multiselect) {
						b(
							"#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(c),
							"#" + b.jgrid.jqID(f.p.id)
						)[f.p.useProp ? "prop" : "attr"]("checked", !1);
						if (d)
							b(
								"#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(c),
								"#" + b.jgrid.jqID(d)
					...
					f.p.multiselect
						? (b(f.p.selarrrow).each(function (a, c) {
								b(b(f).jqGrid("getGridRowById", c))
									.removeClass("ui-state-highlight")
									.attr("aria-selected", "false");
								b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(c))[
				...
				!0 === f.p.cellEdit &&
					...
					(b("td:eq(" + f.p.iCol + ")", f.rows[f.p.iRow]).removeClass(
									...
									if (!0 === g.p.treeGrid && h === g.p.ExpandColumn)
										...
										try {
											f[h] = b.unformat.call(
												g,
												this,
												{ rowId: k.id, colModel: g.p.colModel[a] },
												a
											);
										} catch (c) {
		...
		delRowData: function (e) {
			...
			this.each(function () {
				...
				f = !0;
				this.p.multiselect &&
					((d = b.inArray(e, this.p.selarrrow)),
				...
				this.each(function () {
					...
					x ||
						(void 0 !== e
							...
							: ((e = b.jgrid.randId()),
							  !1 !== this.p.keyIndex &&
									((G = this.p.colModel[this.p.keyIndex + h + k + n].name),
					...
					for (
						var O = 0,
							$ = "",
							K = {},
							Y = b.isFunction(this.p.afterInsertRow) ? !0 : !1;
						O < X;
						...
						if (0 === this.rows.length)
							...
							switch (c) {
								...
								case "before":
									if ((m = b(this).jqGrid("getGridRowById", d)))
										b(m).before(g.join("")), (m = m.rowIndex - 1);
							}
					...
					!0 !== this.p.altRows ||
						x ||
						("last" === c
							? 1 === (this.rows.length - 1) % 2 &&
							  b(this.rows[this.rows.length - 1]).addClass(U)
							: b(this.rows).each(function (a) {
				...
				b(this.p.colModel).each(function (d) {
					...
					"set" === e
						? void 0 !== f[a] &&
						  ...
						  (l = !0))
						: "get" === e &&
						  (g[a] = b("tr.footrow td:eq(" + d + ")", k.grid.sDiv).html());
				});
			});
			return "get" === e ? g : l;
		},
				...
				if (c.grid) {
					...
					b(this.p.colModel).each(function (h) {
						if (-1 !== b.inArray(this.name, e) && this.hidden === g) {
							...
							c.p.footerrow &&
								b("tr.footrow td:eq(" + h + ")", c.grid.sDiv).css("display", f);
							l = parseInt(this.width, 10);
							c.p.tblwidth =
								"none" === f ? c.p.tblwidth - (l + a) : c.p.tblwidth + (l + a);
							this.hidden = !g;
							d = !0;
					...
					!0 === d &&
						(!0 !== c.p.shrinkToFit ||
							isNaN(c.p.height) ||
							(c.p.tblwidth += parseInt(c.p.scrollOffset, 10)),
						b(c).jqGrid(
							"setGridWidth",
							!0 === c.p.shrinkToFit ? c.p.tblwidth : c.p.width
						));
		...
		remapColumns: function (e, f, c) {
			...
			f &&
				a(
					b("#" + b.jgrid.jqID(l.p.id) + " tbody:first"),
					".jqgfirstrow, tr.jqgrow, tr.jqfoot"
				);
			l.p.footerrow && a(b("tbody:first", l.grid.sDiv));
			l.p.remapColumns &&
				(l.p.remapColumns.length
					? d(l.p.remapColumns)
					: (l.p.remapColumns = b.makeArray(e)));
					...
					if (!isNaN(e)) {
						...
						if (!0 === f) {
							...
							k
								...
								: 1 !== Math.abs(e - r - (a + l * h)) &&
								  (p = e - r - (a + l * h));
							c.p.colModel[g].width += p;
							c.p.tblwidth = a + p + l * h + r;
							c.p.tblwidth > e
								? ((k = c.p.tblwidth - parseInt(e, 10)),
								  (c.p.tblwidth = e),
								  (d = c.p.colModel[g].width -= k))
					...
					if (a)
						try {
							c = b.unformat.call(
								this,
								b("td:eq(" + d + ")", a),
								{ rowId: a.id, colModel: this.p.colModel[d] },
								d
							);
						} catch (l) {
		...
		getInd: function (e, f) {
			var c = !1,
				d;
			this.each(function () {
				(d = b(this).jqGrid("getGridRowById", e)) &&
					(c = !0 === f ? d : d.rowIndex);
			});
			return c;
		},
					...
					if (a)
						if (
							...
							37 === d.keyCode &&
								(c.p.treeGrid &&
									c.p.data[h][k] &&
									b(a).find("div.treeclick").trigger("click"),
		...
		getLocalRow: function (e) {
			...
			this.each(function () {
				void 0 !== e &&
					((c = this.p._index[b.jgrid.stripPref(this.p.idPrefix, e)]),
					0 <= c && (f = this.p.data[c]));
			});
			return f;
		},
...
(function (a) {
	...
	a.fn.fmatter.select = function (c, b) {
		...
		void 0 !== b.colModel.formatoptions
			? ((d = b.colModel.formatoptions.value),
			  (f =
					void 0 === b.colModel.formatoptions.separator
						? ":"
						: b.colModel.formatoptions.separator),
			  (g =
					void 0 === b.colModel.formatoptions.delimiter
						? ";"
						: b.colModel.formatoptions.delimiter))
			: void 0 !== b.colModel.editoptions &&
			  ((d = b.colModel.editoptions.value),
			  (f =
					void 0 === b.colModel.editoptions.separator
						? ":"
						: b.colModel.editoptions.separator),
			  (g =
					void 0 === b.colModel.editoptions.delimiter
						? ";"
	...
	a.fn.fmatter.rowactions = function (c) {
		...
		b.hasClass("jqgrid-new-row") &&
			(k.extraparam[g.prmNames.oper] = g.prmNames.addoper);
		b = {
			keys: k.keys,
			oneditfunc: k.onEdit,
			...
			switch (((f = a.jgrid.formatter || {}), g)) {
				...
				case "checkbox":
					h = b.colModel.editoptions
						? b.colModel.editoptions.value.split(":")
						: ["Yes", "No"];
	...
	a.unformat.date = function (c, b) {
		...
		return a.fmatter.isEmpty(c)
			? a.fn.fmatter.defaultFormat(c, b)
			: a.jgrid.parseDate(d.newformat, c, d.srcformat, d);
	};
})(jQuery);
(function (a) {
	a.jgrid.extend({
			...
			return this.each(function () {
				...
				if (this.grid) {
					...
					for (k = 0; k < this.p.colModel.length; k++)
						if (
							this.p.colModel[k].index === a ||
							this.p.colModel[k].name === a
						) {
							h = k;
							!0 === this.p.frozenColumns &&
					...
					var d = function () {
						...
						h = function (e, f, g) {
							...
							var k,
								...
								l = a(e).attr("colname");
							for (
								k = c.p.colModel.length;
								p < k && c.p.colModel[p].name !== l;
							...
							switch (this.stype) {
								case "select":
									if ((m = this.surl || g.dataUrl))
												...
												a.extend(
													{
														...
														success: function (e) {
															void 0 !== g.buildSelect
																...
																: a("td:eq(1)", n).append(e);
															void 0 !== g.defaultValue &&
																a("select", l).val(g.defaultValue);
															a("select", l).attr({
																name: f.index || f.name,
																id: "gs_" + f.name,
															});
										...
										f.searchoptions
											? ((r =
													void 0 === f.searchoptions.value
														? ""
														: f.searchoptions.value),
											  (w =
													void 0 === f.searchoptions.separator
														? ":"
														: f.searchoptions.separator),
											  (u =
													void 0 === f.searchoptions.delimiter
														? ";"
														: f.searchoptions.delimiter))
											: f.editoptions &&
											  ((r =
													void 0 === f.editoptions.value
														? ""
														: f.editoptions.value),
											  (w =
													void 0 === f.editoptions.separator
														? ":"
														: f.editoptions.separator),
											  (u =
													void 0 === f.editoptions.delimiter
														? ";"
								...
								case "custom":
									...
									try {
										if (a.isFunction(g.custom_element))
											if (
												(t = g.custom_element.call(
													c,
													void 0 !== g.defaultValue ? g.defaultValue : "",
													g
												))
											)
			...
			return this.each(function () {
				...
				for (c = 0; c < x; c++)
					if (
						...
						e = a("<th>")
							...
							.addClass(
								"ui-state-default ui-th-column-header ui-th-" + this.p.direction
							)
				...
				b.useColSpanStyle &&
					(p.find("span.ui-jqgrid-resize").each(function () {
						...
						b.is(":visible") &&
							(this.style.cssText =
								"height: " + b.height() + "px !important; cursor: col-resize;");
					}),
					...
					if (
						...
						if (0 <= k && e) {
							...
							a(b).bind("jqGridSortCol.setFrozenColumns", function (c, d, e) {
								...
								b.p.viewsortcols[0] ||
									b.p.lastsort === e ||
									(a("span.s-ico", c).hide(), a("span.s-ico", d).show());
							});
...
(function (a) {
	a.extend(a.jgrid, {
		...
		createModal: function (d, b, c, g, e, h, f) {
			...
			c.zIndex ||
				((g = a(g).parents("*[role=dialog]").filter(":first").css("z-index")),
			...
			l &&
				...
				!h &&
				((g =
					a(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8),
			...
			if (c.drag)
				if ((a(n).css("cursor", "move"), a.fn.jqDrag)) a(k).jqDrag(n);
					...
					try {
						a(k).draggable({ handle: a("#" + a.jgrid.jqID(n.id)) });
					} catch (r) {}
			if (c.resize)
				if (a.fn.jqResize)
					a(k).append(
						...
						a("#" + a.jgrid.jqID(d.themodal)).jqResize(
							".jqResize",
			...
			!0 === c.closeOnEscape &&
				a(k).keydown(function (b) {
					27 == b.which &&
						((b =
							a("#" + a.jgrid.jqID(d.themodal)).data("onClose") || c.onClose),
						m.hideModal("#" + a.jgrid.jqID(d.themodal), {
							gb: c.gbox,
							jqm: c.jqModal,
							onClose: b,
		...
		viewModal: function (d, b) {
			...
			if (a.fn.jqm && !0 === b.jqm)
				...
				"" !== b.gbox &&
					(a(".jqgrid-overlay:first", b.gbox).show(),
		...
		info_dialog: function (d, b, c, g) {
			...
			try {
				"false" === a("#info_dialog").attr("aria-hidden") &&
					a.jgrid.hideModal("#info_dialog", { jqm: h }),
		...
		createEl: function (d, b, c, g, e) {
			...
			switch (d) {
				...
				case "select":
					...
					if (void 0 !== b.dataUrl) {
						d = b.name
							? String(b.id).substring(
									0,
									String(b.id).length - String(b.name).length - 1
							  )
							: String(b.id);
						...
						a.ajax(
							a.extend(
								{
									url: a.isFunction(b.dataUrl)
										? b.dataUrl.call(k, d, c, String(b.name))
										: b.dataUrl,
									type: "GET",
									dataType: "html",
										...
										b &&
											...
											setTimeout(function () {
												a("option", c).each(function (b) {
													...
													if (
														-1 < a.inArray(a.trim(a(this).text()), d) ||
														-1 < a.inArray(a.trim(a(this).val()), d)
													)
						...
						if ("string" === typeof b.value)
							for (n = b.value.split(e), m = 0; m < n.length; m++)
								(q = n[m].split(p)),
									...
									d ||
										...
										(e.selected = "selected"),
									d &&
										(-1 < a.inArray(a.trim(q[1]), g) ||
											-1 < a.inArray(a.trim(q[0]), g)) &&
										(e.selected = "selected");
							...
							for (m in ((p = b.value), p))
								p.hasOwnProperty(m) &&
									...
									f.appendChild(e),
									d ||
										(a.trim(m) !== a.trim(c) && a.trim(p[m]) !== a.trim(c)) ||
										(e.selected = "selected"),
									d &&
										(-1 < a.inArray(a.trim(p[m]), g) ||
											-1 < a.inArray(a.trim(m), g)) &&
										(e.selected = "selected"));
						h(f, b, ["value"]);
					}
					break;
		...
		checkValues: function (d, b, c, g) {
			...
			if (e) {
					...
					!(
						...
						(f[b].formatoptions && f[b].formatoptions.newformat
							? ((f = f[b].formatoptions.newformat),
							  a.jgrid.formatter.date.masks.hasOwnProperty(f) &&
				...
				if (
					!0 === e.time &&
					!((!1 === c && a.jgrid.isEmpty(d)) || a.jgrid.checkTime(d))
				)
					return [
						!1,
				...
				if (!0 === e.custom && (!1 !== c || !a.jgrid.isEmpty(d)))
					return a.isFunction(e.custom_func)
						? ((d = e.custom_func.call(this, d, h, b)),
						  a.isArray(d) ? d : [!1, a.jgrid.edit.msg.customarray, ""])
				...
				if (e.grid) {
					...
					if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0])
						...
						var f = a(
							...
							).insertBefore("#gview_" + a.jgrid.jqID(e.p.id)),
							k = "left",
							u = "";
						"rtl" === e.p.direction &&
							((k = "right"),
						...
						a.isFunction(b.onInitializeSearch) &&
							b.onInitializeSearch.call(e, a("#" + h));
						b.gbox = "#gbox_" + h;
						b.layer
							? a.jgrid.createModal(
									s,
						...
						a("#" + h + "_search").bind("click", function () {
							...
							t &&
								...
								(t = b.onSearch.call(e, e.p.filters));
			...
			return this.each(function () {
						...
						if (b.length) {
							...
							a.each(d.p.colModel, function () {
								if (
									...
									try {
										if (
											((l[c] = this.editoptions.custom_value.call(
												d,
												a("#" + a.jgrid.jqID(c), p),
												"get"
											)),
							...
							d.p.autoencode &&
								(l[this.name] = a.jgrid.htmlEncode(l[this.name]));
						}
					});
					return !0;
				}
				function h(c, e, n, f) {
					...
					a(e.p.colModel).each(function (t) {
						...
						if (
							...
							"_empty" === c &&
								s.defaultValue &&
								(q = a.isFunction(s.defaultValue)
									? s.defaultValue.call(d)
									: s.defaultValue);
							...
							0 === p.length &&
								...
								a(n).append(p),
								(p[0].rp = v));
							a("td:eq(" + (A - 2) + ")", p[0]).html(
								void 0 === y.label ? e.p.colNames[t] : y.label
							);
							a("td:eq(" + (A - 1) + ")", p[0])
								.append(y.elmprefix)
								.append(r)
						...
						a(m).each(function () {
							...
							(l = a("#" + a.jgrid.jqID(g), "#" + n)) &&
								...
								"custom" === this.edittype && a.isFunction(q.custom_value)
									...
									: q.defaultValue
									? ((h = a.isFunction(q.defaultValue)
											? q.defaultValue.call(d)
											: q.defaultValue),
									  "checkbox" === l[0].type
											? ((r = h.toLowerCase()),
											  0 > r.search(/(false|f|0|no|n|off|undefined)/i) &&
											  "" !== r
													? ((l[0].checked = !0),
									...
									if (g === e.p.ExpandColumn && !0 === e.p.treeGrid)
										...
										try {
											f = a.unformat.call(
												e,
												a(this),
												{ rowId: c, colModel: m[l] },
												l
											);
										} catch (q) {
											f =
												"textarea" === m[l].edittype
													? a(this).text()
													: a(this).html();
										}
									...
									switch (m[l].edittype) {
										...
										case "select":
											...
											a("#" + g + " option", "#" + n).each(function () {
												...
												(a.trim(f) !== a.trim(a(this).text()) &&
													...
													? m[l].editoptions.multiple
														? -1 < a.inArray(a.trim(a(this).text()), h) ||
														  -1 < a.inArray(a.trim(a(this).val()), h)
															? (this.selected = !0)
															: (this.selected = !1)
														: (this.selected = !1)
													: (this.selected = !0);
										...
										case "checkbox":
											...
											if (m[l].editoptions && m[l].editoptions.value)
												...
												(f = f.toLowerCase()),
													0 > f.search(/(false|f|0|no|n|off|undefined)/i) &&
													"" !== f
														? (a("#" + g, "#" + n)[
										...
										case "custom":
											try {
												if (
													m[l].editoptions &&
													a.isFunction(m[l].editoptions.custom_value)
												)
													m[l].editoptions.custom_value.call(
														d,
														a("#" + g, "#" + n),
														"set",
														f
				...
				function s() {
					var e,
						...
						u,
						s,
						C = a(d).triggerHandler("jqGridAddEditBeforeCheckValues", [
							a("#" + g),
							B,
						]);
					...
					for (r in l)
						if (
							l.hasOwnProperty(r) &&
							((n = a.jgrid.checkValues.call(d, l[r], r)), !1 === n[0])
						)
							break;
					t();
					n[0] &&
						((f = a(d).triggerHandler("jqGridAddEditClickSubmit", [
							b[d.p.id],
							l,
							B,
						])),
						...
						(n = a(d).triggerHandler("jqGridAddEditBeforeSubmit", [
							l,
							a("#" + g),
							B,
						])),
						...
						n[0] &&
							...
							(n = b[d.p.id].beforeSubmit.call(d, l, a("#" + g), B)));
					if (n[0] && !b[d.p.id].processing) {
						...
						h = k.id;
						l[m] =
							"_empty" === a.trim(l[d.p.id + "_id"]) ? k.addoper : k.editoper;
						l[m] !== k.addoper
							? (l[h] = l[d.p.id + "_id"])
							: void 0 === l[h] && (l[h] = l[d.p.id + "_id"]);
						delete l[d.p.id + "_id"];
						...
						if (!0 === d.p.treeGrid)
							...
							d.p.treeReader))
								d.p.treeReader.hasOwnProperty(s) &&
									((f = d.p.treeReader[s]),
									!l.hasOwnProperty(f) ||
										(l[m] === k.addoper && "parent_id_field" === s) ||
										delete l[f]);
						...
						s = a.extend(
							{
								...
								data: a.isFunction(b[d.p.id].serializeEditData)
									? b[d.p.id].serializeEditData.call(d, l)
									: l,
								complete: function (f, r) {
									...
									300 <= f.status && 304 !== f.status
										? ((n[0] = !1),
										  (n[1] = a(
												d
										  ).triggerHandler("jqGridAddEditErrorTextFormat", [f, B])),
										  a.isFunction(b[d.p.id].errorTextFormat)
												...
												: (n[1] =
														...
														"'. Error code: " +
														f.status))
										: ((n = a(d).triggerHandler("jqGridAddEditAfterSubmit", [
												f,
												l,
												B,
										  ])),
										  void 0 === n && (n = [!0, "", ""]),
										  n[0] &&
												a.isFunction(b[d.p.id].afterSubmit) &&
												(n = b[d.p.id].afterSubmit.call(d, f, l, B)));
									if (!1 === n[0])
										...
										if (
											...
											for (s in b[d.p.id]._savedData)
												b[d.p.id]._savedData.hasOwnProperty(s) &&
													l[s] &&
													(b[d.p.id]._savedData[s] = l[s]);
						...
						n[0] &&
							(b[d.p.id].useDataProxy
								? ((f = d.p.dataProxy.call(d, s, "set_" + d.p.id)),
								  ...
								  !1 === f[0]
										? ((n[0] = !1),
										  (n[1] = f[1] || "Error deleting the selected row!"))
				...
				function u(b, c) {
					...
					0 === b
						...
						: void 0 !== c[1][b - 1] &&
						  a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("ui-state-disabled")
						? a("#pData", p + "_2").addClass("ui-state-disabled")
				...
				if (d.grid && z) {
					var v = d.p.id,
						...
						y = a.isFunction(b[d.p.id].beforeShowForm)
							...
							: !1,
						D = a.isFunction(b[d.p.id].afterShowForm)
							? b[d.p.id].afterShowForm
							: !1,
						A = a.isFunction(b[d.p.id].beforeInitData)
					...
					c.recreateForm ||
						(a(d).data("formProp") &&
							a.extend(b[a(this)[0].p.id], a(d).data("formProp")));
					var N = !0;
					...
					var H = isNaN(b[a(this)[0].p.id].dataheight)
						...
						n = a(d).triggerHandler("jqGridAddEditBeforeInitData", [
							a("#" + g),
							B,
						]);
					void 0 === n && (n = !0);
					...
					if (!1 !== n) {
						...
						y && y.call(d, a("#" + g), B);
						a("#" + a.jgrid.jqID(q.themodal)).data(
							"onClose",
							b[d.p.id].onClose
						);
			...
			return this.each(function () {
					...
					a(d.p.colModel).each(function (b) {
						...
						if ("cb" !== g && "subgrid" !== g && "rn" !== g && D) {
							...
							0 === h.length &&
								...
								a(e).append(h),
								(h[0].rp = n));
							a("td:eq(" + (t - 2) + ")", h[0]).html(
								"<b>" +
									(void 0 === c.label ? d.p.colNames[b] : c.label) +
									"</b>"
							);
							a("td:eq(" + (t - 1) + ")", h[0])
								.append("<span>" + m + "</span>")
				...
				if (r.grid && z) {
					var f = r.p.id,
						...
						g = a.isFunction(b[r.p.id].beforeInitData)
							? b[r.p.id].beforeInitData
							: !1,
						m = !0,
						p = 1,
						q = 0;
					c.recreateForm ||
						(a(r).data("viewProp") &&
							a.extend(b[a(this)[0].p.id], a(r).data("viewProp")));
					...
					if (!1 !== m) {
						...
						a.jgrid.createModal(
							...
							x,
							c,
							"#gview_" + a.jgrid.jqID(r.p.id),
							a("#gview_" + a.jgrid.jqID(r.p.id))[0]
						);
						d &&
						...
						a("#nData", "#" + u + "_2").click(function () {
							...
							-1 !== b[0] &&
								b[1][b[0] + 1] &&
								(a.isFunction(c.onclickPgButtons) &&
									c.onclickPgButtons.call(r, "next", a("#" + k), b[1][b[0]]),
								w(b[1][b[0] + 1], r),
						...
						a("#pData", "#" + u + "_2").click(function () {
							...
							-1 !== b[0] &&
								b[1][b[0] - 1] &&
								(a.isFunction(c.onclickPgButtons) &&
									c.onclickPgButtons.call(r, "prev", a("#" + k), b[1][b[0]]),
								w(b[1][b[0] - 1], r),
								a(r).jqGrid("setSelection", b[1][b[0] - 1]),
								a.isFunction(c.afterclickPgButtons) &&
									c.afterclickPgButtons.call(
			...
			return this.each(function () {
				...
				if (e.grid && z) {
					var h = a.isFunction(b[e.p.id].beforeShowForm),
						...
						t = a.isFunction(b[e.p.id].beforeInitData)
					...
					if (void 0 !== a("#" + a.jgrid.jqID(m.themodal))[0]) {
						...
						var p = isNaN(b[e.p.id].dataheight)
								? b[e.p.id].dataheight
						...
						!0 === c.cancelicon[0] &&
							a("#eData", "#" + k + "_2")
								.addClass(
									"right" === c.cancelicon[1]
										? "fm-button-icon-right"
										: "fm-button-icon-left"
								)
								.append(
									"<span class='ui-icon " + c.cancelicon[2] + "'></span>"
								);
						a("#dData", "#" + k + "_2").click(function () {
							...
							a.isFunction(b[e.p.id].onclickSubmit) &&
								(r = b[e.p.id].onclickSubmit.call(e, b[e.p.id], h) || {});
							a.isFunction(b[e.p.id].beforeSubmit) &&
								(f = b[e.p.id].beforeSubmit.call(e, h));
							if (f[0] && !b[e.p.id].processing) {
								...
								for (g in h)
									h.hasOwnProperty(g) &&
										(h[g] = a.jgrid.stripPref(e.p.idPrefix, h[g]));
								u[x] = h.join();
								a(this).addClass("ui-state-active");
								g = a.extend(
									{
										url:
											b[e.p.id].url || a(e).jqGrid("getGridParam", "editurl"),
										type: b[e.p.id].mtype,
										data: a.isFunction(b[e.p.id].serializeDelData)
											? b[e.p.id].serializeDelData.call(e, u)
											: u,
										complete: function (d, g) {
											...
											300 <= d.status && 304 !== d.status
												...
												: a.isFunction(b[e.p.id].afterSubmit) &&
												  (f = b[e.p.id].afterSubmit.call(e, d, u));
											if (!1 === f[0])
					...
					if (f.grid && "string" === typeof b) {
						...
						for (x = 0; x < u; x++) {
							...
							0 === x
								? ((m = b),
								  (p = f.p.id),
								  m === f.p.toppager && ((p += "_top"), (u = 1)))
								: ((m = f.p.toppager), (p = f.p.id + "_top"));
							"rtl" === f.p.direction &&
								a(g).attr("dir", "rtl").css("float", "right");
							c.add &&
								((h = h || {}),
								...
								a(k, g)
									...
									.click(function () {
										if (!a(this).hasClass("ui-state-disabled")) {
											var b;
											f.p.multiselect
												? ((b = f.p.selarrrow), 0 === b.length && (b = null))
												: (b = f.p.selrow);
											b
									...
									.click(function () {
										a(this).hasClass("ui-state-disabled") ||
											(a.isFunction(c.searchfunc)
												? c.searchfunc.call(f, t)
												: a(f).jqGrid("searchGrid", t));
										return !1;
									})
									.hover(d, v),
									...
									.click(function () {
										if (!a(this).hasClass("ui-state-disabled")) {
											...
											try {
												...
												a.isFunction(f.clearToolbar) &&
													f.clearToolbar.call(f, !1);
											} catch (e) {}
							...
							f.p._nvtd &&
								(k > f.p._nvtd[0] &&
									(a(m + "_" + c.position, m).width(k), (f.p._nvtd[0] = k)),
								(f.p._nvtd[1] = k));
							g = k = k = null;
							this.nav = !0;
						}
				...
				if (this.grid) {
					...
					if (e && (!c.id || void 0 === a("#" + a.jgrid.jqID(c.id), e)[0])) {
						...
						a(w, e)
							...
							.click(function (b) {
								a(this).hasClass("ui-state-disabled") ||
									(a.isFunction(c.onClickButton) && c.onClickButton.call(h, b));
								return !1;
							})
							.hover(
								function () {
		...
		FormToGrid: function (b, c, e, h) {
			return this.each(function () {
				if (this.grid) {
					...
					"add" === e
						? a(this).jqGrid("addRowData", b, t, h)
						: "set" === e && a(this).jqGrid("setRowData", b, t);
				}
			});
		},
	});
					...
					for (d = 0; d < q; d++)
						(f = this.p.columns[d]),
							...
							f.sorttype
								...
								: f.searchtype || (f.searchtype = "string"),
						...
						if (!0 === this.p.ruleButtons) {
							...
							h.bind("click", function () {
								...
								for (c = 0; c < b.p.columns.length; c++) {
									var e =
											void 0 === b.p.columns[c].search
												? !0
												: b.p.columns[c].search,
										l = !0 === b.p.columns[c].hidden;
									if (
										(!0 === b.p.columns[c].searchoptions.searchhidden && e) ||
										(e && !l)
									) {
										f = b.p.columns[c];
										break;
					...
					this.createTableRowForRule = function (g, l) {
						...
						q.bind("change", function () {
							...
							if (k) {
								...
								w &&
									"text" === k.inputtype &&
									!k.searchoptions.size &&
									(k.searchoptions.size = 10);
								var d = a.jgrid.createEl.call(
									c,
									k.inputtype,
									k.searchoptions,
									"",
								...
								a.jgrid.msie &&
									9 > a.jgrid.msiever() &&
									((l =
										parseInt(a("select.selectopts", f)[0].offsetWidth, 10) + 1),
								...
								a(".input-elm", f).bind("change", function (e) {
									e = e.target;
									g.data =
										"SPAN" === e.nodeName.toUpperCase() &&
										k.searchoptions &&
										a.isFunction(k.searchoptions.custom_value)
											? k.searchoptions.custom_value.call(
													c,
													a(e).children(".customelement:first"),
													"get"
											  )
											: e.value;
									b.onchange();
						...
						for (e = p = 0; e < b.p.columns.length; e++) {
							...
							if (
								(!0 === b.p.columns[e].searchoptions.searchhidden && s) ||
								(s && !u)
							)
								(s = ""),
									g.field === b.p.columns[e].name &&
										((s = " selected='selected'"), (p = e)),
									(d +=
										"<option value='" +
										b.p.columns[e].name +
										"'" +
						...
						function a(b) {
							...
							if (void 0 !== b.rules)
								for (f = 0; f < b.rules.length; f++) {
									...
									if (d.p.errorcheck) {
										for (
											var h = void 0, n = void 0, h = 0;
											h < d.p.columns.length;
											h++
										)
...
(function (a) {
	...
	a.jgrid.extend({
		editRow: function (c, e, b, l, h, n, p, g, f) {
			...
			return this.each(function () {
				...
				d.grid &&
					...
					!1 !== l &&
						((b = a.isFunction(m.beforeEditRow)
							? m.beforeEditRow.call(d, m, c)
							: void 0),
						void 0 === b && (b = !0),
						b &&
									...
									if (l) e = a("span:first", this).html();
										...
										try {
											e = a.unformat.call(
												d,
												this,
												{ rowId: c, colModel: q[b] },
												b
											);
										} catch (m) {
											e =
												q[b].edittype && "textarea" === q[b].edittype
													? a(this).text()
													: a(this).html();
										}
									if (
										...
										"subgrid" !== f &&
										"rn" !== f &&
										(d.p.autoencode && (e = a.jgrid.htmlDecode(e)),
										(n[f] = e),
										!0 === q[b].editable)
									) {
										null === h && (h = b);
		...
		saveRow: function (c, e, b, l, h, n, p) {
			...
			if (!1 === u) return m;
			g = a.isFunction(f.beforeSaveRow)
				? f.beforeSaveRow.call(d, f, c)
				: void 0;
			void 0 === g && (g = !0);
			if (g) {
				g = a(u).attr("editable");
								...
								case "custom":
									try {
										if (
											...
											if (
												((k[r] = t.editoptions.custom_value.call(
													d,
					...
					if (!1 === z[0]) {
						try {
							...
							a.jgrid.info_dialog(
								...
								z[1],
								a.jgrid.edit.bClose,
								{ left: s[0], top: s[1] + a(q).outerHeight() }
							);
						} catch (A) {
							alert(z[1]);
						}
					...
					k &&
						...
						void 0 === k[s] || "" === k[s]
							...
							: u.id !== d.p.idPrefix + k[s] &&
							  ...
							  void 0 !== d.p._index[g] &&
									((d.p._index[k[s]] = d.p._index[g]), delete d.p._index[g]),
							  (c = d.p.idPrefix + k[s]),
							  a(u).attr("id", c),
							  d.p.selrow === q && (d.p.selrow = c),
							  a.isArray(d.p.selarrrow) &&
									((g = a.inArray(q, d.p.selarrrow)),
								...
								a.extend(
									{
										...
										complete: function (b, e) {
											...
											if ("success" === e) {
												var g = !0,
													h;
												h = a(d).triggerHandler("jqGridInlineSuccessSaveRow", [
													b,
													c,
													f,
												]);
												...
												if (!0 === g) {
													...
													a(d).triggerHandler("jqGridInlineErrorSaveRow", [
														...
														a.isFunction(f.errorfunc) &&
															f.errorfunc.call(d, c, b, e, null),
														!0 === f.restoreAfterError &&
															a(d).jqGrid("restoreRow", c, f.afterrestorefunc);
											}
										},
		...
		restoreRow: function (c, e) {
			...
			"object" === a.type(b[0])
				? (l = b[0])
				: a.isFunction(e) && (l.afterrestorefunc = e);
			...
			return this.each(function () {
				...
				if (
					...
					!1 !== p &&
						((f = a.isFunction(l.beforeCancelRow)
							? l.beforeCancelRow.call(b, l, sr)
							: void 0),
						void 0 === f && (f = !0),
						f))
				) {
					...
					if (0 <= e) {
						if (a.isFunction(a.fn.datepicker))
							try {
								a("input.hasDatepicker", "#" + a.jgrid.jqID(p.id)).datepicker(
									"hide"
								);
							} catch (m) {}
						...
						a("#" + a.jgrid.jqID(c), "#" + a.jgrid.jqID(b.p.id)).hasClass(
							"jqgrid-new-row"
						) &&
							setTimeout(function () {
		...
		addRow: function (c) {
			...
			return this.each(function () {
				if (this.grid) {
					var e = this,
						b = a.isFunction(c.beforeAddRow)
							? c.beforeAddRow.call(e, c.addRowParams)
							: void 0;
					void 0 === b && (b = !0);
					b &&
						...
						a("#" + a.jgrid.jqID(c.rowID), "#" + a.jgrid.jqID(e.p.id)).addClass(
							"jqgrid-new-row"
						),
						c.useFormatter
							? a(
									"#" + a.jgrid.jqID(c.rowID) + " .ui-inline-edit",
									"#" + a.jgrid.jqID(e.p.id)
							  ).click()
							: ((b = e.p.prmNames),
							...
							onClickButton: function () {
								...
								if (c) {
									...
									a("#" + a.jgrid.jqID(c), "#" + h).hasClass("jqgrid-new-row")
										? ((e.addParams.addRowParams.extraparam[m] = f.addoper),
										  (d = e.addParams.addRowParams))
										: (e.editParams.extraparam ||
												(e.editParams.extraparam = {}),
						...
						(a(b).jqGrid("navButtonAdd", c, {
							...
							onClickButton: function () {
								var c = b.p.savedRow[0].id,
									f = e.editParams;
								c
									? (a("#" + a.jgrid.jqID(c), "#" + h).hasClass(
											"jqgrid-new-row"
									  ) && (f = e.addParams.addRowParams),
					...
					if ("subgrid" !== g && "cb" !== g && "rn" !== g) {
						...
						if (
							...
							0 <= parseInt(c.p.iCol, 10) &&
								...
								b(c).triggerHandler("jqGridSelectCell", [
									c.rows[d].id,
									g,
									e,
									d,
							...
							try {
								e = b.unformat.call(
									c,
									h,
									{ rowId: c.rows[d].id, colModel: k },
									f
								);
							} catch (m) {
								e =
									k.edittype && "textarea" === k.edittype
										? b(h).text()
										: b(h).html();
							}
							...
							b.isFunction(c.p.beforeEditCell) &&
								c.p.beforeEditCell.call(c, c.rows[d].id, g, e, d, f);
							...
							b.isFunction(c.p.afterEditCell) &&
								c.p.afterEditCell.call(c, c.rows[d].id, g, e, d, f);
						}
						c.p.iCol = f;
						c.p.iRow = d;
					}
					...
					if (null !== c) {
						...
						switch (k.edittype) {
							...
							case "checkbox":
								...
								h = e = b("#" + d + "_" + l, a.rows[d]).is(":checked")
									? n[0]
									: n[1];
								break;
							case "password":
							...
							case "custom":
								try {
									if (
										...
										e = k.editoptions.custom_value.call(
											a,
											b(".customelement", g),
											"get"
										);
						...
						if (h !== a.p.savedRow[c].v) {
							if (
								(c = b(a).triggerHandler("jqGridBeforeSaveCell", [
									a.rows[d].id,
									m,
									e,
									d,
							...
							if (!0 === s[0]) {
								c =
									b(a).triggerHandler("jqGridBeforeSubmitCell", [
										a.rows[d].id,
										m,
										e,
										d,
											...
											b.extend(
												{
													...
													data: b.isFunction(a.p.serializeCellData)
														? a.p.serializeCellData.call(a, p)
														: p,
													type: "POST",
														...
														if ("success" === k) {
															...
															!0 === l[0]
																? (b(g).empty(),
																  ...
																  b(a).triggerHandler("jqGridAfterSaveCell", [
																		a.rows[d].id,
																		m,
																		e,
																		d,
			...
			return this.each(function () {
				...
				if (a.grid && !0 === a.p.cellEdit) {
					...
					if (null !== c) {
						...
						b(a).triggerHandler("jqGridAfterRestoreCell", [
							a.rows[d].id,
							a.p.savedRow[c].v,
							d,
							f,
			...
			return this.each(function () {
				function d(c, d, e) {
					if ("v" === e.substr(0, 1)) {
						...
						"vd" === e &&
							n >= f &&
							(b(a.grid.bDiv)[0].scrollTop =
								b(a.grid.bDiv)[0].scrollTop + a.rows[c].clientHeight);
						"vu" === e &&
							r < g &&
							(b(a.grid.bDiv)[0].scrollTop =
								b(a.grid.bDiv)[0].scrollTop - a.rows[c].clientHeight);
					...
					"h" === e &&
						...
						a.rows[c].cells[d].offsetLeft + a.rows[c].cells[d].clientWidth >=
						e + parseInt(f, 10)
							? (b(a.grid.bDiv)[0].scrollLeft =
									b(a.grid.bDiv)[0].scrollLeft + a.rows[c].cells[d].clientWidth)
							: g < f &&
							  (b(a.grid.bDiv)[0].scrollLeft =
									b(a.grid.bDiv)[0].scrollLeft -
										...
										if (b(this).hasClass("dirty-cell"))
											try {
												e[c] = b.unformat.call(
													a,
													this,
													{ rowId: a.rows[g].id, colModel: a.p.colModel[f] },
													f
												);
											} catch (k) {
		...
		q = function (a) {
			...
			b &&
				(c(".jqmID" + d.s).each(function () {
					...
					if (
						h.top <= a.pageY &&
						a.pageY <= h.top + d.height() &&
						h.left <= a.pageX &&
						a.pageX <= h.left + d.width()
					)
						return (b = !1);
				}),
				p(d));
	...
	b.jgrid.extend({
		setSubGrid: function () {
			return this.each(function () {
				...
				if (d[0])
					for (
						d[0].align = b.extend([], d[0].align || []), c = 0;
						c < d[0].name.length;
						c++
					)
			...
			return this.each(function () {
				...
				if (a.grid) {
					var p = function (c, d, h) {
							d = b(
								"<td align='" + a.p.subGridModel[0].align[h] + "'></td>"
							).html(d);
							b(c).append(d);
						},
						n = function (c, d) {
							...
							c &&
								...
								b(e.root + " " + e.row, c).each(function () {
									...
									if (!0 === e.repeatitems)
										...
										var c =
											a.p.subGridModel[0].mapping || a.p.subGridModel[0].name;
										if (c)
											...
											b.extend(
												{
													...
													data: b.isFunction(a.p.serializeSubGridData)
														? a.p.serializeSubGridData.call(a, d)
														: d,
													complete: function (c) {
														"xml" === a.p.subgridtype
															? n(c.responseXML, e)
															: r(b.jgrid.parse(c.responseText), e);
													},
												},
												b.jgrid.ajaxOptions,
							...
							b(a.rows[q].cells[d]).bind("click", function () {
								...
								if (b(this).hasClass("sgcollapsed")) {
									...
									if (
										...
										(!1 === a.p.subGridOptions.reloadOnExpand &&
											!b(l).hasClass("ui-subgrid"))
									) {
										...
										b.isFunction(a.p.subGridRowExpanded)
											? a.p.subGridRowExpanded.call(a, m + "_" + e, e)
											: v(c);
									} else b(l).show();
									b(this)
										.html(
									...
									e = c.id;
									g &&
										b.isFunction(a.p.subGridRowColapsed) &&
										(g = a.p.subGridRowColapsed.call(a, m + "_" + e, e));
									if (!1 === g) return !1;
									!0 === a.p.subGridOptions.reloadOnExpand
									...
									a.p.subGridOptions.selectOnCollapse &&
										b(a).jqGrid("setSelection", e);
								}
								return !1;
							}),
				...
				if (null === c || ("object" !== typeof c && !d.isFunction(c)))
					...
					for (b = 0; b < c.groupField.length; b++)
						c.groupOrder[b] || (c.groupOrder[b] = "asc"),
							...
							"boolean" !== typeof c.groupColumnShow[b] &&
								(c.groupColumnShow[b] = !0),
							"boolean" !== typeof c.groupSummary[b] &&
								(c.groupSummary[b] = !1),
							c.groupSummaryPos[b] || (c.groupSummaryPos[b] = "footer"),
							!0 === c.groupColumnShow[b]
								? ((c.visibiltyOnNextGrouping[b] = !0),
								  d(this).jqGrid("showCol", c.groupField[b]))
								: ((c.visibiltyOnNextGrouping[b] = d(
										"#" + d.jgrid.jqID(this.p.id + "_" + c.groupField[b])
								  ).is(":visible")),
					...
					(e = a.groupField[g]),
						...
						void 0 !== f &&
							(0 === k
								...
								: "object" === typeof f ||
								  (d.isArray(a.isInTheSameGroup) &&
								  d.isFunction(a.isInTheSameGroup[g])
								...
								? 1 === p
									...
									: ((a.counters[g].cnt += 1),
									  (a.groups[a.counters[g].pos].cnt = a.counters[g].cnt))
								: (a.groups.push({
										idx: g,
										dataIndex: e,
										value: f,
		...
		groupingToggle: function (b) {
			this.each(function () {
					...
					if (k.showSummaryOnHide) {
						if (e)
							for (
								...
								!(
									d(e).hasClass("jqfoot") &&
									parseInt(d(e).attr("jqfootlevel"), 10) <= c
								);
				...
				d.isFunction(this.p.onClickGroup) &&
					this.p.onClickGroup.call(this, b, r);
			});
			return !1;
		},
		groupingRender: function (b, k, a, c) {
			return this.each(function () {
				...
				d.each(f.groups, function (g, l) {
					if (
						f._locgr &&
						!(l.startRow + l.cnt > (a - 1) * c && l.startRow < a * c)
					)
						return !0;
					x++;
					...
					p =
						...
						"');return false;\"></span>";
					try {
						d.isArray(f.formatDisplayField) &&
						d.isFunction(f.formatDisplayField[l.idx])
					...
					if (z - 1 === l.idx) {
						...
						if ("header" !== f.groupSummaryPos[l.idx]) {
							...
							if (void 0 !== s) {
								for (
									w = 0;
									w < f.groupField.length && s.dataIndex !== f.groupField[w];
									w++
								);
		...
		groupingGroupBy: function (b, k) {
			return this.each(function () {
				...
				for (c = 0; c < a.groupField.length; c++)
					!a.groupColumnShow[c] &&
						a.visibiltyOnNextGrouping[c] &&
						d(this).jqGrid("showCol", a.groupField[c]);
				for (c = 0; c < b.length; c++)
					a.visibiltyOnNextGrouping[c] = d(
						"#" + d.jgrid.jqID(this.p.id) + "_" + d.jgrid.jqID(b[c])
					).is(":visible");
			...
			return this.each(function () {
				...
				if (!0 === b) {
					...
					for (a = 0; a < k.groupField.length; a++)
						!k.groupColumnShow[a] &&
							k.visibiltyOnNextGrouping[a] &&
							d(this).jqGrid("showCol", k.groupField);
					d(
						"tr.jqgroup, tr.jqfoot",
						"#" + d.jgrid.jqID(this.p.id) + " tbody:first"
					).remove();
					d(
						"tr.jqgrow:hidden",
						"#" + d.jgrid.jqID(this.p.id) + " tbody:first"
			...
			handler: function (b, d, a, c, g, m) {
				var e = {
					...
					min: function () {
						return "" === d
							? parseFloat(m[a] || 0)
							: Math.min(parseFloat(d), parseFloat(m[a] || 0));
					},
					max: function () {
						return "" === d
							? parseFloat(m[a] || 0)
							: Math.max(parseFloat(d), parseFloat(m[a] || 0));
					},
					count: function () {
						"" === d && (d = 0);
				...
				null != c &&
					("fixed" === g
						? (b = b.toFixed(c))
						: ((c = Math.pow(10, c)), (b = Math.round(b * c) / c)));
				return b;
			},
		},
	});
					...
					for (
						...
						(l = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id)),
							...
							(q +=
								...
								"px;' class='ui-icon "),
							void 0 !== l[n] &&
								(l[n] = "true" === l[n] || !0 === l[n] ? !0 : !1),
							"true" === l[k] || !0 === l[k]
								? ((q +=
										(void 0 !== l[f] && "" !== l[f]
											? l[f]
											: a.p.treeIcons.leaf) + " tree-leaf treeclick"),
								  (l[k] = !0),
								  (p = "leaf"))
								: ((l[k] = !1), (p = "")),
							(l[e] =
							...
							m !== parseInt(a.p.tree_root_level, 10) &&
								((l =
									(l = d(a).jqGrid("getNodeParent", l)) && l.hasOwnProperty(e)
										? l[e]
										: !0) ||
							...
							d(a.rows[b].cells[h])
								...
								.bind("click", function (b) {
									b = d.jgrid.stripPref(
										a.p.idPrefix,
										d(b.target || b.srcElement, a.rows).closest("tr.jqgrow")[0]
											.id
									);
									b = a.p._index[b];
									a.p.data[b][k] ||
							...
							!0 === a.p.ExpandColClick &&
								d(a.rows[b].cells[h])
									...
									.bind("click", function (b) {
										b = d.jgrid.stripPref(
											a.p.idPrefix,
											d(b.target || b.srcElement, a.rows).closest(
												"tr.jqgrow"
											)[0].id
										);
										var c = a.p._index[b];
				...
				if (b.p.treeGrid) {
					...
					for (e in b.p.colModel)
						if (b.p.colModel.hasOwnProperty(e))
							...
							c++,
							b.p.treeReader))
								b.p.treeReader.hasOwnProperty(k) &&
									b.p.treeReader[k] === a &&
									g.push(a);
		...
		expandRow: function (b) {
			this.each(function () {
				...
				if (c.grid && c.p.treeGrid) {
					...
					d(a).each(function () {
						var a =
							c.p.idPrefix + d.jgrid.getAccessor(this, c.p.localReader.id);
					...
					switch (c.p.treeGridModel) {
						case "nested":
							...
							d(c.p.data).each(function () {
								parseInt(this[a], 10) === parseInt(c.p.tree_root_level, 10) &&
									b.push(this);
							});
							break;
						case "adjacency":
							...
							d(c.p.data).each(function () {
								(null !== this[h] &&
									"null" !== String(this[h]).toLowerCase()) ||
									b.push(this);
							});
					}
			});
					...
					switch (a.p.treeGridModel) {
						...
						case "adjacency":
							var m = a.p.treeReader.parent_id_field,
								p = a.p.localReader.id;
							d(this.p.data).each(function () {
								this[m] == d.jgrid.stripPref(a.p.idPrefix, b[p]) &&
									c.push(this);
							});
					}
			});
					...
					switch (a.p.treeGridModel) {
						case "nested":
							var e = a.p.treeReader.left_field,
								...
								m = parseInt(b[g], 10);
							d(this.p.data).each(function () {
								parseInt(this[g], 10) >= m &&
									parseInt(this[e], 10) >= f &&
									parseInt(this[e], 10) <= n &&
									c.push(this);
							});
							break;
						case "adjacency":
						...
						d(this).jqGrid("isNodeLoaded", this.p.data[m])
							...
							: this.grid.hDiv.loading ||
							  ...
							  "nested" === this.p.treeGridModel
									...
									: d(this).jqGrid("setGridParam", {
											postData: { nodeid: f, parentid: b[a], n_level: b[e] },
									  }),
							  d(this).trigger("reloadGrid"),
							  (b[h] = !0),
							  "nested" === this.p.treeGridModel
			...
			return this.each(function () {
				if (this.grid && this.p.treeGrid) {
					...
					d.each(f, function (a) {
						...
						d("#" + d.jgrid.jqID(n.p.id) + " tbody tr:eq(" + a + ")").after(
							d("tr#" + d.jgrid.jqID(b), n.grid.bDiv)
						);
					});
					f = m = e = null;
				}
			...
			if (a) {
				...
				void 0 === c || null === c || "" === c
					...
					: ((l = "after"),
					  ...
					  s.length
							? ((v = s = s[s.length - 1][e.p.localReader.id]),
							  (s = d(e).jqGrid("getInd", v) + 1))
					...
					if (null !== c) {
						...
						if (f.length)
							for (r in f)
								f.hasOwnProperty(r) &&
									((f[r][m] =
										f[r][m] > g ? parseInt(f[r][m], 10) + 2 : f[r][m]),
									(f[r][p] =
										f[r][p] >= g ? parseInt(f[r][p], 10) + 2 : f[r][p]));
						a[m] = g;
						a[p] = g + 1;
					} else {
	...
	d.jgrid.extend({
		pivotSetup: function (q, n) {
			...
			this.each(function () {
							...
							switch (a[b].aggregator) {
								...
								case "min":
									s =
										"" === w || null == w
											? parseFloat(q[p] || 0)
											: Math.min(parseFloat(w), parseFloat(q[p] || 0));
									break;
								case "max":
									s =
										"" === w || null == w
											? parseFloat(q[p] || 0)
											: Math.max(parseFloat(w), parseFloat(q[p] || 0));
							}
							t[u] = x[y] = s;
						}
						r[m] = n;
							...
							if (
								...
								("level" === g &&
									...
									F[a.level] !== a.text &&
										...
										(e = 1 === b ? K : G + (b - 1) * z),
										(f[a.level - 1].groupHeaders[b - 1].startColumnName =
											h[e].name),
										(f[a.level - 1].groupHeaders[b - 1].numberOfColumns =
											h.length - e),
										(G = h.length)),
									(F[a.level] = a.text)),
							...
							if ("level" === g && 0 < a.level)
								for (d in ((b = 0), a.fields)) {
									...
									1 < z
										...
										: ((e.name = a.text),
										  (e.label =
												"_r_Totals" === a.text ? c.rowTotalsText : a.text));
									h.push(e);
									b++;
								}
						}
				...
				var x;
				for (a = 0; a < s; a++)
					(x = { name: c.xDimension[a].dataName, frozen: c.frozenStaticCols }),
				...
				for (var A = {}; p < y; ) {
					...
					for (B in r) {
						if (0 === m)
							(A.children && void 0 !== A.children) ||
								(A = { text: B, level: 0, children: [] }),
								(k = A.children);
						else {
							t = null;
							...
							t
								? (k = t.children)
								: (k.push({ children: [], text: B, level: m, fields: r[B] }),
			...
			return this.each(function () {
				function v(b) {
					...
					for (b = 0; b < f.groupOptions.groupingView.groupField.length; b++)
						e.orderBy(
							f.groupOptions.groupingView.groupField[b],
							"a",
							"text",
							""
						);
					...
					if (f.length)
						for (b = 0; b < f.length; b++)
							f[b] &&
								f[b].groupHeaders.length &&
								jQuery(r).jqGrid("setGroupHeaders", f[b]);
							...
							d.extend(
								{
									...
									success: function (b) {
										v(
											d.jgrid.getAccessor(b, e && e.reader ? e.reader : "rows")
										);
									},
								},
								e || {}
						...
						if (xmlJsonClass.xml2json && c.jgrid.parse) {
							...
							h
								? ((h = e.grid.datatype),
								  ...
								  (e.grid.datastr = a),
								  c(d).jqGrid(f).jqGrid("setGridParam", { datatype: h }))
								: c(d).jqGrid(f);
		...
		if (1 === a.nodeType) {
			if (a.attributes.length) {
				...
				for (f = 0; f < a.attributes.length; f += 1)
					b["@" + a.attributes[f].nodeName] = (
						a.attributes[f].nodeValue || ""
					).toString();
			}
			if (a.firstChild) {
				var e = (f = 0),
		...
		if ("innerHTML" in a) b = a.innerHTML;
			...
			var g = function (a) {
				...
				if (1 === a.nodeType) {
					...
					3 === a.nodeType
						? (b += a.nodeValue)
						: 4 === a.nodeType && (b += "<![CDATA[" + a.nodeValue + "]]\x3e");
				return b;
			};
			...
			for (b = 0; b < f.length; b++)
				(a = null),
					0 < g.length &&
						(a = g[b]) &&
						a.replace &&
						(a = encodeURIComponent(a).replace(/[.\-%]/g, "_")),
					null === a && (a = b + 1),
	...
	b.jgrid.extend({
		...
		columnChooser: function (a) {
			...
			if (!b("#colchooser_" + b.jgrid.jqID(c[0].p.id)).length) {
				...
				a = b.extend(
					{
						...
						apply_perm: function () {
							b("option", g).each(function () {
								this.selected
									? c.jqGrid("showCol", k[this.value].name)
									: c.jqGrid("hideCol", k[this.value].name);
							});
							var e = [];
				...
				var q = b.isFunction(a.dlog_opts)
						...
						!0 === d.p.rownumbers &&
							b("td.jqgrid-rownum", d.rows).each(function (a) {
								b(this).html(
									a +
										1 +
										(parseInt(d.p.page, 10) - 1) * parseInt(d.p.rowNum, 10)
								);
							});
		...
		gridDnD: function (a) {
			return this.each(function () {
				function d() {
					var a = b.data(c, "dnd");
					b("tr.jqgrow:not(.ui-draggable)", c).draggable(
						b.isFunction(a.drag) ? a.drag.call(b(c), a) : a.drag
					);
				}
				var c = this,
					e,
				...
				if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable)
					if (
									...
									return b.extend(
										{
											start: function (e, d) {
												...
												for (
													f = 0;
													f < b.data(c, "dnd").connectWith.length;
													f++
												)
													0 ===
														b(b.data(c, "dnd").connectWith[f]).jqGrid(
															"getGridParam",
															"reccount"
														) &&
														b(b.data(c, "dnd").connectWith[f]).jqGrid(
												...
												if (b(d.draggable).hasClass("jqgrow")) {
													...
													if (!a.dropbyname) {
														var g = 0,
															...
															h,
															n,
															s = b("#" + b.jgrid.jqID(this.id)).jqGrid(
																"getGridParam",
																"colModel"
															);
														try {
						...
						for (
							...
							(g = a.connectWith[e]),
								b(g).droppable(
									b.isFunction(a.drop) ? a.drop.call(b(c), a) : a.drop
								);
			});
		},

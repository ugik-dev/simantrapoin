	...
	return (
		a.extend(b.prototype, {
						...
						document.body.appendChild(b),
							e &&
								...
								void 0 !== b.style[a] &&
									...
									(d = window
										.getComputedStyle(b)
										.getPropertyValue(e.prefix + "transform")),
									(c.transform = {
										prefix: e.prefix,
										name: a,
										translate: !0,
			...
			slide: function (a, b) {
				...
				if (f !== a && 1 !== this.num) {
					if (
						(b || (b = this.options.transitionSpeed), this.support.transform)
					) {
						for (
						...
						(a = this.circle(a)),
							...
							this.move(a, 0, b),
							this.options.continuous &&
								this.move(this.circle(a - c), -(this.slideWidth * c), 0);
					} else
						(a = this.circle(a)),
					...
					this.elements[this.index] > 1 &&
						(this.timeout = this.setTimeout(
							(!this.requestAnimationFrame && this.slide) ||
								function (a, c) {
									b.animationFrameId = b.requestAnimationFrame.call(
										window,
										function () {
											b.slide(a, c);
										}
			...
			close: function () {
				var a = this,
					b = function (c) {
						c.target === a.container[0] &&
							(a.container.off(a.support.transition.end, b), a.handleClose());
					};
				this.options.onclose && this.options.onclose.call(this),
					this.support.transition && this.options.displayTransition
						? (this.container.on(this.support.transition.end, b),
			...
			animate: function (a, b, c) {
				...
				var d = this,
					...
					f = window.setInterval(function () {
						...
						return g > c
							? ((d.slidesContainer[0].style.left = b + "px"),
							  d.ontransitionend(),
							  void window.clearInterval(f))
							: void (d.slidesContainer[0].style.left =
									(b - a) * (Math.floor((g / c) * 100) / 100) + a + "px");
					}, 4);
			},
				...
				if (!(d.length > 1 || (e && 1 !== e)))
					if (
						...
						void 0 === this.isScrolling &&
							(this.isScrolling =
								this.isScrolling || Math.abs(b) < Math.abs(this.touchDelta.y)),
						this.isScrolling)
					)
						this.options.closeOnSwipeUpOrDown &&
							this.translateY(f, this.touchDelta.y + this.positions[f], 0);
					else
						for (
							a.preventDefault(),
								window.clearTimeout(this.timeout),
								this.options.continuous
									...
									: ((this.touchDelta.x = b /=
											(!f && b > 0) || (f === this.num - 1 && 0 > b)
												? Math.abs(b) / this.slideWidth + 1
												: 1),
									  (c = [f]),
									  f && c.push(f - 1),
			...
			ontouchend: function (a) {
				...
				var b,
					...
					k =
						(j && Math.abs(this.touchDelta.x) > 20) ||
						Math.abs(this.touchDelta.x) > i / 2,
					l =
						(!g && this.touchDelta.x > 0) ||
						(g === this.num - 1 && this.touchDelta.x < 0),
					m =
						!k &&
						this.options.closeOnSwipeUpOrDown &&
						((j && Math.abs(this.touchDelta.y) > 20) ||
				...
				this.options.continuous && (l = !1),
					...
					this.isScrolling
						...
						? ((c = g + b),
						  ...
						  (f = -i * b),
						  this.options.continuous
								? (this.move(this.circle(c), e, 0),
								  this.move(this.circle(g - 2 * b), f, 0))
						  ...
						  this.onslide(g))
						: this.options.continuous
						? (this.move(this.circle(g - 1), -i, h),
						  this.move(g, 0, h),
						  this.move(this.circle(g + 1), i, h))
						: (g && this.move(g - 1, -i, h),
						  this.move(g, 0, h),
						  g < this.num - 1 && this.move(g + 1, i, h));
			},
			...
			ontransitionend: function (a) {
				...
				(a && b !== a.target) ||
					...
					this.setTimeout(this.options.onslideend, [this.index, b]));
			},
			oncomplete: function (b) {
				...
				d &&
					...
					"error" === b.type
						? (a(e).addClass(this.options.slideErrorClass),
						  (this.elements[c] = 3))
						: (this.elements[c] = 2),
					d.clientHeight > this.container[0].clientHeight &&
						(d.style.maxHeight = this.container[0].clientHeight),
				...
				switch (a.which || a.keyCode) {
					case 13:
						this.options.toggleControlsOnReturn &&
							(this.preventDefault(a), this.toggleControls());
						break;
					case 27:
					...
					case 32:
						this.options.toggleSlideshowOnSpace &&
							(this.preventDefault(a), this.toggleSlideshow());
						break;
					case 37:
						this.options.enableKeyboardNavigation &&
							(this.preventDefault(a), this.prev());
						break;
					case 39:
						this.options.enableKeyboardNavigation &&
							(this.preventDefault(a), this.next());
				}
			},
			handleClick: function (b) {
				...
				f(c.toggleClass)
					...
					? (this.preventDefault(b),
					  c.closeOnSlideClick ? this.close() : this.toggleControls())
					: e.parentNode &&
			...
			setTitle: function (a) {
				...
				c.length &&
					...
					b && c[0].appendChild(document.createTextNode(b)));
			},
					...
					k = function (b) {
						if (!d) {
							...
							(d = !0),
								...
								j &&
									"load" === b.type &&
									((e.style.background = 'url("' + i + '") center no-repeat'),
									(e.style.backgroundSize = j)),
								c(b);
						}
					};
				return (
					...
					j === !0 && (j = "contain"),
					(j =
						this.support.backgroundSize && this.support.backgroundSize[j] && j),
					j
						? (e = this.elementPrototype.cloneNode(!1))
						: ((e = h), (h.draggable = !1)),
					f && (e.title = f),
					a(h).on("load error", k),
					(h.src = i),
			...
			createElement: function (b, c) {
				...
				return (
					f ||
						((f = this.elementPrototype.cloneNode(!1)),
						this.setTimeout(c, [{ type: "error", target: f }])),
			...
			loadElement: function (b) {
				this.elements[b] ||
					(this.slides[b].firstChild
						? (this.elements[b] = a(this.slides[b]).hasClass(
						...
						: ((this.elements[b] = 1),
						  ...
						  this.slides[b].appendChild(
								this.createElement(this.list[b], this.proxyListener)
						  )));
			},
			...
			getDataProperty: function (b, c) {
				if (b.getAttribute) {
					var d = b.getAttribute(
						"data-" + c.replace(/([A-Z])/g, "-$1").toLowerCase()
					);
					if ("string" == typeof d) {
						if (
			...
			getItemProperty: function (a, b) {
				...
				return (
					void 0 === c &&
						((c = this.getDataProperty(a, b)),
						void 0 === c && (c = this.getNestedProperty(a, b))),
					c
				);
			},
			initStartIndex: function () {
				...
				if (b && "number" != typeof b)
					for (a = 0; a < this.num; a += 1)
						if (
							this.list[a] === b ||
							this.getItemProperty(this.list[a], c) ===
								this.getItemProperty(b, c)
						) {
							b = a;
							break;
						}
			...
			initEventListeners: function () {
				var b = this,
					...
					d = function (a) {
						var c =
							b.support.transition && b.support.transition.end === a.type
								? "transitionend"
								: a.type;
						b["on" + c](a);
					};
			...
			initWidget: function () {
				var b = this,
					c = function (a) {
						a.target === b.container[0] &&
							(b.container.off(b.support.transition.end, c), b.handleOpen());
					};
				return (
			...
			initOptions: function (b) {
				(this.options = a.extend({}, this.options)),
					((b && b.carousel) ||
						(this.options.carousel && (!b || b.carousel !== !1))) &&
		...
		return (
			a.extend(b.prototype, {
				...
				videoFactory: function (b, c, d) {
					...
					if (
						(m.addClass(k.videoContentClass), r && (l.title = r), o.canPlayType)
					)
						...
						o.src &&
							...
							(d || a(o))
								...
								.on("pause", function () {
									(h = !1),
										m
											.removeClass(j.options.videoLoadingClass)
											.removeClass(j.options.videoPlayingClass),
								...
								.on("playing", function () {
									(h = !1),
										m
											.removeClass(j.options.videoLoadingClass)
											.addClass(j.options.videoPlayingClass),
										j.container.hasClass(j.options.controlsClass)
											? ((i = !0),
											  j.container.removeClass(j.options.controlsClass))
											: (i = !1);
								})
								.on("play", function () {
		...
		return (
			...
			a.extend(b.prototype, {
				...
				textFactory: function (a, b) {
					...
					return g
						? (void 0 === this.getItemProperty(a, f.urlProperty) &&
								(a[f.urlProperty] = "//vimeo.com/" + g),
						  (e += 1),
						  this.videoFactory(
								a,
								b,
					...
					return f
						? (void 0 === this.getItemProperty(a, e.urlProperty) &&
						  ...
						  void 0 === this.getItemProperty(a, e.videoPosterProperty) &&
								(a[e.videoPosterProperty] =
									"//img.youtube.com/vi/" + f + "/maxresdefault.jpg"),
						  this.videoFactory(
								a,
								b,
								new d(f, e.youTubePlayerVars, e.youTubeClickToPlay)
						  ))
						: c.call(this, a, b);
				},
			}),

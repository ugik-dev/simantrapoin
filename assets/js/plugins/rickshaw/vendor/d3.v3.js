d3 = (function () {
	...
	function b(n) {
		...
		return function (e, r) {
			...
			r
				? ((t.lastIndex = 0),
				  t.test(u) || e.setAttribute("class", y(u + " " + n)))
	...
	function nt(n, t, e) {
		return n > 0
			? B(Math.atan2(e, t) * na, Math.sqrt(t * t + e * e), n)
			: B(0 / 0, 0 / 0, n);
	}
	function tt(n) {
	...
	function Mt() {
		var n = bt(),
			t = _t() - n;
		t > 24
			? (isFinite(t) && (clearTimeout(Ma), (Ma = setTimeout(Mt, t))), (ya = 0))
			: ((ya = 1), ba(Mt));
	}
	function xt(n, t, e) {
	...
	function bt() {
		var n = Date.now();
		for (xa = va; xa; )
			n >= xa.time && (xa.flush = xa.callback(n - xa.time)), (xa = xa.next);
		return n;
	}
	function _t() {
		for (var n, t = va, e = 1 / 0; t; )
			t.flush
				? (t = n ? (n.next = t.next) : (va = t.next))
	...
	function Gt(n, t) {
		return (
			((n = n.point)[0] < 0 ? n[1] - Jo - Go : Jo - n[1]) -
			((t = t.point)[0] < 0 ? t[1] - Jo - Go : Jo - t[1])
		);
	}
	function Kt(n, t) {
		var e = n[0],
	...
	function re(n, t, e, r) {
		...
		return function (c) {
			...
			function d() {
				m && (v(x, b), _ && E && T.rejoin(), m.push(T.buffer())),
					(q.point = g),
					E && c.lineEnd();
			}
			function v(n, t) {
	...
	function Pe(n, t) {
		...
		return i
			? ((e.invert = function (n, t) {
					...
					return [
						Math.atan2(n, e) / i,
						2 * Math.atan(Math.pow(o / r, 1 / i)) - Jo,
					];
			  }),
			  e)
			: Re;
	...
	function Ue(n) {
		...
		return (
			...
			(t.interpolate = function (n) {
				return arguments.length
					? ((o = "function" == typeof n ? (i = n) : (i = gc.get(n) || Xe).key),
					  t)
					: o;
			}),
	...
	function Ke(n, t) {
		return n.length < 3
			? Xe(n)
			: n[0] +
					nr((n.push(n[0]), n), tr([n[n.length - 2]].concat(n, [n[1]]), t));
	}
	function Qe(n, t) {
				...
				rightOf: function (n, t) {
					...
					if (1 === e.a) {
						...
						if (
							...
							(c =
								e.b * (o * o - i * i) < l * i * (1 + (2 * o) / l + e.b * e.b)),
								e.b < 0 && (c = !c);
						}
					} else {
						var s = e.c - e.a * t.x,
			...
			i = {
				...
				insert: function (n, t, e) {
					...
					for (var r = 0, u = i.list, o = u.length; o > r; r++) {
						var a = u[r];
						if (
							!(n.ystar > a.ystar || (n.ystar == a.ystar && t.x > a.vertex.x))
						)
							break;
					}
					u.splice(r, 0, n);
	...
	function Sr(n, t) {
		...
		for (n += "", t += "", Mc.lastIndex = 0, r = 0; (e = Mc.exec(t)); ++r)
			e.index && l.push(t.substring(a, (c = e.index))),
				...
				(a = Mc.lastIndex);
		for (
			a < t.length && l.push(t.substring(a)), r = 0, i = s.length;
			(e = Mc.exec(n)) && i > r;
			++r
		)
			if (((o = s[r]), o.x == e[0])) {
				if (o.i)
					if (null == l[o.i + 1])
						...
						for (
							l[o.i - 1] += o.x + l[o.i + 1], l.splice(o.i, 2), u = r + 1;
							i > u;
							++u
						)
							s[u].i -= 2;
					...
					for (
						l[o.i] = o.x + l[o.i + 1], l.splice(o.i + 1, 1), u = r + 1;
						i > u;
						++u
					)
						s[u].i--;
	...
	function Er(n, t) {
		for (
			var e, r = mo.interpolators.length;
			--r >= 0 && !(e = mo.interpolators[r](n, t));
	...
	function Zr(n) {
		...
		t[0] * e[1] < e[0] * t[1] &&
			((t[0] *= -1), (t[1] *= -1), (r *= -1), (u *= -1)),
			(this.rotate =
				(r ? Math.atan2(t[1], t[0]) : Math.atan2(-e[0], e[1])) * na),
		...
		return (
			a[0] != c[0] || a[1] != c[1]
				? (r.push("translate(", null, ",", null, ")"),
				  u.push({ i: 1, x: wr(a[0], c[0]) }, { i: 3, x: wr(a[1], c[1]) }))
				: c[0] || c[1]
				? r.push("translate(" + c + ")")
				: r.push(""),
			l != s
	...
	function Qr(n, t) {
		if (n === t) return n;
		for (
			var e = Kr(n), r = Kr(t), u = e.pop(), i = r.pop(), o = null;
			u === i;
	...
	function iu(n, t) {
		return (
			mo.rebind(n, t, "sort", "children", "value"),
			(n.nodes = n),
			(n.links = lu),
			n
		);
			...
			if (
				...
				for (
					...
					if (1 == p)
						for (
							c = r._pack_prev;
							c !== a._pack_prev && !Lu(c, i);
							c = c._pack_prev, v++
						);
					p
						? (v > d || (d == v && u.r < r.r) ? ju(r, (u = a)) : ju((r = c), u),
						  o--)
						: (Du(r, i), (u = i), t(i));
				}
			var m = (s + f) / 2,
	...
	function ii(n, t, e, r) {
		...
		return (
			...
			(o.tickFormat = function (n, t) {
				...
				arguments.length < 2
					? (t = qc)
					: "function" != typeof t && (t = mo.format(t));
				var r,
	...
	function oi(n, t, e) {
		...
		return (
			...
			(r.exponent = function (o) {
				return arguments.length
					? ((u = ai((t = o))), (i = ai(1 / t)), n.domain(e.map(u)), r)
					: t;
			}),
			(r.copy = function () {
	...
	function ci(n, t) {
		...
		return (
			...
			(e.rangePoints = function (u, i) {
				...
				return (
					(o = r(n.length < 2 ? (c + l) / 2 : c + (s * i) / 2, s)),
					(a = 0),
					...
					function (r) {
						...
						function c(r) {
							...
							for (var u = r / g, a = f(u), c = p.length; c > 0; )
								p[--c].call(n, a);
							return u >= 1
								? (o.event && o.event.end.call(n, s, t), l())
								: void 0;
						}
						function l() {
	...
	(mo.nest = function () {
		function n(t, a, c) {
			...
			for (
				var l, s, f, h, g = -1, p = a.length, d = o[c++], v = new u();
				++g < p;
		...
		(Ro.selectAll = function (n) {
			...
			for (var u = -1, i = this.length; ++u < i; )
				for (var o = this[u], a = -1, c = o.length; ++a < c; )
					(e = o[a]) &&
						(r.push((t = Mo(n.call(e, e.__data__, a, u)))), (t.parentNode = e));
			return p(r);
		});
	var Yo = {
			...
			function r(n, t, e, r) {
				return function () {
					...
					var c,
						...
						y = L();
					i
						? ((c = i.apply(l, arguments)), (c = [c.x - d[0], c.y - d[1]]))
						: (c = [0, 0]),
						f({ type: "dragstart" });
				};
			}
	...
	(mo.interpolateZoom = function (n, t) {
		...
		(mo.behavior.zoom = function () {
			...
			function s() {
				...
				function i() {
					for (
						var n, t, e, i, o = mo.touches(p), c = 0, l = o.length;
						l > c;
						++c, i = null
					)
				...
				function h() {
					if (mo.event.touches.length) {
						for (
							var t = mo.event.changedTouches, e = 0, r = t.length;
							r > e;
							++e
						)
			...
			function d() {
				...
				o(n),
					r(
						Math.pow(
							2,
							mo.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1
						)
					),
					u(e, i),
					a(n),
			...
			return (
				...
				(n.x = function (t) {
					return arguments.length
						? ((b = t), (x = t.copy()), (S = { x: 0, y: 0, k: 1 }), n)
						: b;
				}),
				(n.y = function (t) {
					return arguments.length
						? ((w = t), (_ = t.copy()), (S = { x: 0, y: 0, k: 1 }), n)
						: w;
				}),
				mo.rebind(n, C, "on")
			);
	...
	(ca.brighter = function (n) {
		return B(
			this.h,
			this.c,
			Math.min(100, this.l + la * (arguments.length ? n : 1))
		);
	}),
		(ca.darker = function (n) {
			return B(
				this.h,
				this.c,
				Math.max(0, this.l - la * (arguments.length ? n : 1))
			);
		}),
		(ca.rgb = function () {
		...
		(mo.dsv = function (n, t) {
			...
			return (
				...
				(e.parseRows = function (n, t) {
					...
					for (
						var r, u, i = {}, o = {}, a = [], c = n.length, s = 0, f = 0;
						(r = e()) !== o;
	...
	(mo.timer = function (n, t, e) {
		...
		ma ? (ma.next = i) : (va = i),
			(ma = i),
			ya || ((Ma = clearTimeout(Ma)), (ya = 1), ba(Mt));
	}),
	...
	var Aa = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
		Na = mo.map({
			...
			r: function (n, t) {
				return (n = mo.round(n, St(n, t))).toFixed(
				...
				(n.translate = function (t) {
					...
					return (
						...
						(r = o
							...
							.clipExtent([
								[s - 0.425 * l + Go, f + 0.12 * l + Go],
								[s - 0.214 * l - Go, f + 0.234 * l - Go],
							])
							.stream(c).point),
						(u = a
							.translate([s - 0.205 * l, f + 0.212 * l])
							.clipExtent([
								[s - 0.214 * l + Go, f + 0.166 * l + Go],
								[s - 0.115 * l - Go, f + 0.234 * l - Go],
							])
							.stream(c).point),
						n
					);
	...
	(mo.geo.transform = function (n) {
		...
		(mo.geo.path = function () {
			...
			return (
				...
				(n.projection = function (n) {
					return arguments.length
						? ((u = (e = n) ? n.stream || Me(n) : dt), t())
						: e;
				}),
				(n.context = function (n) {
					return arguments.length
						? ((i = null == (r = n) ? new se() : new ve(n)),
		...
		(mo.geo.rotation = function (n) {
			...
			return (
				...
				(t.invert = function (t) {
					return (
						(t = n.invert(t[0] * Qo, t[1] * Qo)), (t[0] *= na), (t[1] *= na), t
					);
				}),
				t
			);
	...
	(mo.geom.hull = function (n) {
		function t(n) {
			...
			for (i = 1; m > i; ++i)
				(t[i][1] < t[b][1] || (t[i][1] == t[b][1] && t[i][0] < t[b][0])) &&
					(b = i);
			for (i = 0; m > i; ++i)
				i !== b &&
					((c = t[i][1] - t[b][1]),
					(a = t[i][0] - t[b][0]),
					M.push({ angle: Math.atan2(c, a), index: i }));
			for (
				M.sort(function (n, t) {
		...
		(mc.clip = function (n) {
			for (
				...
				for (
					...
					(o = t[e]),
						gr(o, s, u)
							? (gr(i, s, u) || n.push(pr(i, o, s, u)), n.push(o))
							: gr(i, s, u) && n.push(pr(i, o, s, u)),
						(i = o);
				a && n.push(n[0]), (s = u);
			}
			return n;
	...
	(mo.layout.hierarchy = function () {
		function n(t, o, a) {
			...
			if (((t.depth = o), a.push(t), c && (l = c.length))) {
				for (
					var l, s, f = -1, h = (t.children = []), g = 0, p = o + 1;
					++f < l;
	...
	mo.layout.stack = function () {
		...
		return (
			...
			(n.order = function (t) {
				return arguments.length
					? ((e = "function" == typeof t ? t : Ac.get(t) || gu), n)
					: e;
			}),
			(n.offset = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : Nc.get(t) || pu), n)
					: r;
			}),
			(n.x = function (t) {
				return arguments.length ? ((i = t), n) : i;
			...
			if (g > 0)
				for (i = -1; ++i < h; )
					(a = l[i]),
						a >= s[0] &&
							a <= s[1] &&
							((o = c[mo.bisect(f, a, 1, g) - 1]), (o.y += p), o.push(n[i]));
			return c;
		}
		var t = !0,
			e = Number,
				...
				function c(n, t, r) {
					if (t) {
						...
						a && !wu(o) && ((o._tree.thread = a), (o._tree.mod += f - s)),
							i &&
								!_u(c) &&
								((c._tree.thread = i), (c._tree.mod += l - h), (r = n));
					}
					return r;
				}
			...
			return (
				...
				(i.padding = function (n) {
					function t(t) {
						...
						return null == e
							? Vu(t)
							: Xu(t, "number" == typeof e ? [e, e, e, e] : e);
					}
					function e(t) {
						return Xu(t, n);
					}
	...
	(Uc.call = Ro.call),
		...
		(Uc.styleTween = function (n, t, e) {
			function r(r, u) {
				var i = t.call(
					...
					r,
					u,
					_o.getComputedStyle(this, null).getPropertyValue(n)
				);
				return (
					i &&
					function (t) {
		...
		(Uc.transition = function () {
			for (
				var n, t, e, r, u = this.id, i = ++Zc, o = [], a = 0, c = this.length;
				c > a;
				a++
			) {
				o.push((n = []));
	...
	mo.svg.brush = function () {
		function n(i) {
			i.each(function () {
				...
				c && ((s = Bu(c)), h.attr("x", s[0]).attr("width", s[1] - s[0]), e(f)),
					l &&
						((s = Bu(l)), h.attr("y", s[0]).attr("height", s[1] - s[0]), r(f)),
					t(f);
			});
		}
		function t(n) {
		...
		function u() {
			function u() {
				32 == mo.event.keyCode &&
					(N || ((M = null), (q[0] -= s[1]), (q[1] -= h[1]), (N = 2)), f());
			}
			function g() {
				32 == mo.event.keyCode &&
					2 == N &&
					((q[0] += s[1]), (q[1] += h[1]), (N = 0), f());
			}
			function v() {
				var n = mo.mouse(b),
					u = !1;
			...
			function m(n, t, e) {
				...
				return (
					...
					N
						? (u = (r += f) + v)
						: (M && (f = Math.max(c, Math.min(l, 2 * M[e] - r))),
						  r > f ? ((u = r), (r = f)) : (u = f)),
					g[0] != r || g[1] != u
						? (e ? (o = null) : (i = null), (g[0] = r), (g[1] = u), !0)
						: void 0
				);
			}
			function y() {
	...
	(Wc.year = Ci(
		...
		Gc.forEach(function (n, t) {
			...
			var e = (Wc[n] = Ci(
				function (n) {
					return (
						(n = Wc.day(n)).setDate(n.getDate() - ((n.getDay() + t) % 7)), n
					);
				},
				function (n, t) {

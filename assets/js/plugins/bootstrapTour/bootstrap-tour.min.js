			...
			return (
									...
									if (
										...
										s.reflex &&
											t(s.reflexElement)
												...
												.off(
													n._reflexEvent(s.reflex) + ".tour-" + n._options.name
												),
										s.backdrop &&
					...
					return this.ended()
						...
						: (a = this.getStep(t)) &&
						  ...
						  !a.redirect ||
								...
								(this._redirect(a, t, o),
								this._isJustPathHashDifferent(a.host, o, e.location)))
						? ((r = (function (e) {
								return function (o) {
									if (e._isOrphan(a)) {
										if (!1 === a.orphan)
				...
				(o.prototype._redirect = function (o, n, i) {
					...
					return t.isFunction(o.redirect)
						...
						: ((r =
								"[object String]" === {}.toString.call(o.host)
									? "" + o.host + i
									: i),
						  ...
						  this._getState("redirect_to") !== "" + n
								...
								: (this._debug("Error redirection loop to " + i),
								  this._removeState("redirect_to"),
								  null != o.onRedirectError
										? o.onRedirectError(this)
										: void 0));
				}),
				...
				(o.prototype._scrollIntoView = function (e) {
					var o, n, i, r, s, a, h, p;
					if (((h = this.getStep(e)), !(o = t(h.element)).length))
						return this._showPopoverAndOverlay(e);
					switch (
						((n = t(window)),
						(s = o.offset().top),
						(r = o.outerHeight()),
							...
							.on(
								...
								function (e) {
									...
									return (
										e.preventDefault(),
										(n = t(this)).text(
											o._paused ? n.data("pause-text") : n.data("resume-text")
										),
				...
				(o.prototype._showBackground = function (o, n) {
					...
					for (
						s = t(e).height(),
							...
							l = [],
							a = 0,
							h = (u = ["top", "bottom", "left", "right"]).length;
						a < h;
						a++
					)
						switch (
							((p = u[a]),
							(i =
								null != (r = this.backdrops)[p]
									? r[p]
									: (r[p] = t("<div>", { class: "tour-backdrop " + p }))),
				...
				(o.prototype._hideOverlayElement = function (e) {
					var o, n, i;
					t(e.backdropElement).removeClass("tour-step-backdrop"),
						(i = this.backdrops);
				...
				(o.prototype._getHost = function (t) {
					return (
						(t = t.split("//")), (t = t.length > 1 ? t[1] : t[0]).split("/")[0]
					);
				}),
				...
				(o.prototype._equal = function (t, e) {
					...
					if (
						...
						for (n = o = 0, i = t.length; o < i; n = ++o)
							if (((a = t[n]), !this._equal(a, e[n]))) return !1;
						return !0;
					}
					return t === e;
				}),

...
!(function (a) {
			...
			g = function (a, d, e, h) {
				...
				if (
					...
					if (
						...
						return (
							(m.type = "text/javascript"), (m.src = d), void l.appendChild(m)
						);
					}
				}
				b(function (b, c) {
	...
	function g(a, b) {
		"function" == typeof a && ((b = a), (a = {})),
			...
			"string" == typeof U.ns &&
				(U.ns = { namespaces: [U.ns], defaultNs: U.ns }),
			"string" == typeof U.fallbackNS && (U.fallbackNS = [U.fallbackNS]),
			("string" == typeof U.fallbackLng || "boolean" == typeof U.fallbackLng) &&
				(U.fallbackLng = [U.fallbackLng]),
		...
		if ((M && M.Deferred && (d = M.Deferred()), !U.resStore)) {
			...
			for (var f = 0, g = U.preload.length; g > f; f++)
				for (
					var h = Y.toLanguages(U.preload[f]), i = 0, j = h.length;
					j > i;
					i++
				)
	...
	function i(a, b) {
		...
		for (var c = 0, d = a.length; d > c; c++)
			U.preload.indexOf(a[c]) < 0 && U.preload.push(a[c]);
		return g(b);
	}
	function j(a, b, c, d, e) {
		"string" != typeof b
			? ((c = b), (b = U.ns.defaultNs))
	...
	function r(a, b) {
		...
		for (var e = 0, f = U.preload.length; f > e; e++)
			for (var g = Y.toLanguages(U.preload[e]), h = 0, i = g.length; i > h; h++)
						...
						U.ns.namespaces.indexOf(c) < 0 && U.ns.namespaces.push(c),
							Y.each(j, function (a, f) {
								(O[f] = O[f] || {}),
									...
									0 === e &&
										b &&
										(U.useLocalStorage && N.sync._storeLocal(O), b());
							});
					});
			  })
			: b && b();
	...
	function x() {
		function a(a, b, c) {
			if (0 !== b.length) {
				...
				var f;
				if ("html" === d)
					(f = U.defaultValueFromContent
						? M.extend({ defaultValue: a.html() }, c)
						: c),
						a.html(M.t(b, f));
				else if ("text" === d)
					(f = U.defaultValueFromContent
						? M.extend({ defaultValue: a.text() }, c)
						: c),
						a.text(M.t(b, f));
				else if ("prepend" === d)
					(f = U.defaultValueFromContent
					...
					f = U.defaultValueFromContent
						? M.extend({ defaultValue: a.data(g) }, c)
						: c;
					var h = M.t(b, f);
					a.data(g, h), a.attr(d, h);
				} else
					(f = U.defaultValueFromContent
						? M.extend({ defaultValue: a.attr(d) }, c)
						: c),
						a.attr(d, M.t(b, f));
			}
		}
	...
	function y() {
		...
		N.translateObject = function (a, c) {
			for (
				var d = a.querySelectorAll("[" + U.selectorAttr + "]"),
					e = 0,
					f = d.length;
				f > e;
				e++
	...
	function z(a, b, c, d) {
		...
		if (
			((d = d || b),
			a.indexOf(d.interpolationPrefix || U.interpolationPrefix) < 0)
		)
			return a;
		var e = d.interpolationPrefix
				? Y.regexEscape(d.interpolationPrefix)
				: U.interpolationPrefixEscaped,
			f = d.interpolationSuffix
				? Y.regexEscape(d.interpolationSuffix)
				: U.interpolationSuffixEscaped,
		...
		for (
			...
			if (-1 != j.indexOf(c)) {
				...
				if (-1 != j.indexOf(d, k) && -1 != j.indexOf(e, k)) {
					...
					try {
						(f = Y.extend(f, JSON.parse(j.substring(l, m)))),
							(j = j.substring(0, k));
					} catch (n) {}
				}
			}
	...
	function I(a, b) {
		if (
			("undefined" != typeof b && "object" != typeof b
				...
				: (b = b || {}),
			"object" == typeof U.defaultVariables &&
				(b = Y.extend({}, U.defaultVariables, b)),
			void 0 === a || null === a || "" === a)
		)
			return "";
		...
		c.indexOf(h) > -1 && ((e = c.split(h)), (j = e[0]), (c = e[1])),
			void 0 === g &&
				...
				(b.lng
					? U.missingKeyHandler(i[0], j, c, f, i)
					: U.missingKeyHandler(U.lng, j, c, f, i));
		var k;
		(k =
	...
	function J(a, b) {
		...
		if (
			(b.lngs && (f = b.lngs),
			b.lng && ((f = Y.toLanguages(b.lng, b.fallbackLng)), !O[f[0]]))
		) {
			var g = U.getAsync;
			(U.getAsync = !1),
		...
		if (B(b)) {
			(c = Y.extend({}, b)),
				delete c.context,
				(c.defaultValue = U.contextNotFound);
			var k = h + i + a + "_" + b.context;
			if (((d = F(k, c)), d != U.contextNotFound))
				return z(d, { context: b.context });
		}
		if (C(b, f[0])) {
		...
		if (D(b)) {
			...
			var p =
				...
				i +
				a +
				((b.count && !C(b, f[0])) || !b.count ? U.indefiniteSuffix : "");
			if (((d = F(p, o)), d != U.indefiniteNotFound)) return d;
		}
		for (
			var q,
				r = b.keyseparator || U.keyseparator,
				s = a.split(r),
				t = 0,
				u = f.length;
			u > t && void 0 === q;
			...
			for (var v = f[t], w = 0, x = O[v] && O[v][h]; s[w]; )
				(x = x && x[s[w]]), w++;
				...
				if ("string" == typeof x) (x = z(x, b)), (x = A(x, b));
					...
					if (null === x && U.fallbackOnNull === !0) x = void 0;
						...
						if (U.returnObjectTrees || b.returnObjectTrees) {
							...
							U.objectTreeKeyHandler &&
							"function" == typeof U.objectTreeKeyHandler
		...
		if (
			void 0 === q &&
			!b.isFallbackLookup &&
			(U.fallbackToDefaultNS === !0 ||
				(U.fallbackNS && U.fallbackNS.length > 0))
		) {
			if (((b.isFallbackLookup = !0), U.fallbackNS.length)) {
				for (var H = 0, K = U.fallbackNS.length; K > H; H++)
					if (
						((q = J(U.fallbackNS[H] + i + a, b)),
						q || ("" === q && U.fallbackOnEmpty === !1))
					) {
	...
	function K() {
		...
		if ("undefined" != typeof navigator) {
			if (navigator.languages)
				for (var f = 0; f < navigator.languages.length; f++)
					c.push(navigator.languages[f]);
				...
				if (window.localStorage)
					for (var b in a)
						(a[b].i18nStamp = new Date().getTime()),
							Y.localStorage.setItem("res_" + b, JSON.stringify(a[b]));
			},
				...
				Y.ajax({
					...
					error: function (a, b, c) {
						if ((b && 200 == b) || (a && a.status && 200 == a.status))
							Y.error("There is a typo in: " + e);
						else if ((b && 404 == b) || (a && a.status && 404 == a.status))
							Y.log("Does not exist: " + e);
						else {
			...
			postMissing: function (a, b, c, d, e) {
				...
				if ("fallback" === U.sendMissingTo && U.fallbackLng[0] !== !1)
					for (var h = 0; h < U.fallbackLng.length; h++)
						g.push({
							lng: U.fallbackLng[h],
							url: z(U.resPostPath, { lng: U.fallbackLng[h], ns: b }),
						});
				else if (
					"current" === U.sendMissingTo ||
					("fallback" === U.sendMissingTo && U.fallbackLng[0] === !1)
				)
					g.push({ lng: a, url: z(U.resPostPath, { lng: a, ns: b }) });
				else if ("all" === U.sendMissingTo)
					for (var h = 0, i = e.length; i > h; h++)
						g.push({ lng: e[h], url: z(U.resPostPath, { lng: e[h], ns: b }) });
	...
	var U = {
		...
		Y = {
			...
			getCountyIndexOfLng: function (a) {
				var b = 0;
				return (
					("nb-NO" === a || "nn-NO" === a || "nb-no" === a || "nn-no" === a) &&
						(b = 1),
					b
				);
			},
			toLanguages: function (a, b) {
				...
				var e = [],
					...
					g = function (a) {
						!f || f.indexOf(a) > -1
							? e.push(a)
							: d("rejecting non-whitelisted language: " + a);
					};
				if ("string" == typeof a && a.indexOf("-") > -1) {
					var h = a.split("-");
					"unspecific" !== U.load && g(c(a)),
						"current" !== U.load && g(c(h[this.getCountyIndexOfLng(a)]));
				} else g(c(a));
				for (var i = 0; i < b.length; i++)
					-1 === e.indexOf(b[i]) && b[i] && e.push(c(b[i]));
				return e;
			},
				...
				getItem: function (a, b) {
					if (window.localStorage)
						try {
							...
							return void Y.log(
								'failed to get value for key "' + a + '" from localStorage.'
							);
						}
				},
			},
		...
		_ = {
			rules: (function () {
				var a,
					b = {};
				for (a = Z.length; a--; )
					b[Z[a][0]] = { name: Z[a][1], numbers: Z[a][2], plurals: $[Z[a][3]] };
				return b;
			})(),
			...
			needsPlural: function (a, b) {
				...
				return (
					(c =
						_.currentRule && _.currentRule.lng === a
							? _.currentRule.rule
							: _.rules[d[Y.getCountyIndexOfLng(a)]]),
							...
							if (((h = c[f]), h[2]))
								for (e = d[l], g = 0; g < h[2].length; g++) {
									if (!e.hasOwnProperty(h[2][g]))
										throw ca('[sprintf] property "%s" does not exist', h[2][g]);
									e = e[h[2][g]];
								}
							else e = h[1] ? d[h[1]] : d[l++];
							if (/[^s]/.test(h[8]) && "number" != a(e))
								throw ca("[sprintf] expecting number but found %s", a(e));
							switch (h[8]) {
								case "b":
									e = e.toString(2);
									break;
				...
				(c.parse = function (a) {
					for (var b = a, c = [], d = [], e = 0; b; ) {
						if (null !== (c = /^[^\x25]+/.exec(b))) d.push(c[0]);
							...
							if (
								null ===
								(c = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(
									b
								))
							)
								throw "[sprintf] huh?";

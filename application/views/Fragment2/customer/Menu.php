         ...
         <div class="iq-menu-horizontal-tab">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu d-flex justify-content-left">
                  <li>
                     <a href="<?= base_url('FOController') ?>" class="active iq-waves-effect collapsed" data-toggle="" aria-expanded="false"><i class="ri-home-4-line"></i><span>Dashboard</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                     <!-- <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                                       <li><a href="index.html">Dashboard 1</a></li>
                                       <li><a href="dashboard1.html">Dashboard 2</a></li>
                                       <li><a href="dashboard-2.html">Dashboard 3</a></li>
                                       <li><a href="dashboard-3.html">Dashboard 4</a></li>
                                    </ul> -->
                  </li>
                  ...
                  <li class="active">
                     <a href="<?= base_url('CustomerController/pengajuan') ?>" class=" active iq-waves-effect collapsed" aria-expanded="false"><i class="ri-pencil-ruler-line"></i><span>Daftar Pengajuan</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  </li>

                  <li class="">
                     <a href="<?= base_url('Service/New') ?>" class="iq-waves-effect collapsed" aria-expanded="false"><i class="ri-profile-line"></i><span>Service</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  </li>
                  <li class="">

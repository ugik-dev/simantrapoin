         ...
         <div class="iq-menu-horizontal-tab">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu d-flex justify-content-left">
                  <li>
                     <a href="<?= base_url('KabidController') ?>" class="active iq-waves-effect collapsed" data-toggle="" aria-expanded="false"><i class="ri-home-4-line"></i><span>Dashboard</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  ...
                  <li class="active">
                     <a href="<?= base_url('KabidController/pengajuan') ?>" class=" active iq-waves-effect collapsed" aria-expanded="false"><i class="ri-pencil-ruler-line"></i><span>Daftar Pengajuan</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                  </li>
                  <!-- <li>

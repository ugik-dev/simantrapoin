...
<head>
   ...
   <!-- Typography CSS -->
   <!-- http://cdn.datatables.net/1.10.24/css/jquery.dataTables.min.css -->
   ...
   <!-- Full calendar -->
   <link src='<?= base_url('assets/') ?>fullcalendar/core/main.css' rel='stylesheet' />
...
<script type="text/javascript" src="<?= base_url('assets/') ?>datatables/datatables.min.js"></script> -->
   ...
   <script type="text/javascript" src="https://cdn.datatables.net/v/bs4/dt-1.10.24/af-2.3.5/b-1.7.0/b-colvis-1.7.0/b-html5-1.7.0/b-print-1.7.0/cr-1.5.3/date-1.0.2/fc-3.3.2/fh-3.1.8/kt-2.6.1/r-2.2.7/rg-1.1.2/rr-1.2.7/sc-2.0.3/sb-1.0.1/sp-1.2.2/sl-1.3.2/datatables.min.js"></script>

   <script type="text/javascript" src="<?= base_url('assets/') ?>js/myfunction.js"></script>
...
<script src="<?= base_url('assets/') ?>js/plugins/dataTables/datatables.min.js"></script>
   ...
   <!-- <link href="<?= base_url('assets/') ?>css/plugins/jquery-autocomplete.css" rel="stylesheet"> -->

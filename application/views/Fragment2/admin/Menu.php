            ...
            <div class="iq-menu-horizontal-tab">
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu d-flex justify-content-left">
                        ...
                        <li class="active">
                            <a href="<?= base_url('AdminController/Kelolahuser') ?>" class=" active iq-waves-effect collapsed" aria-expanded="false"><i class="ri-pencil-ruler-line"></i><span>Kelolah User</span><i class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                        </li>
                    </ul>
                </nav>
            </div>

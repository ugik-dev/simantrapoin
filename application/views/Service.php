...
<script>
    $(document).ready(function() {
        ...
        var ipal = {
            ...
            'nib_file': new FileUploader($('#form_ipal').find('#nib_file'), "", "nib_file", ".png , .pdf , .jpg , .jpeg", false, true),
            'izin_lingkungan': new FileUploader($('#form_ipal').find('#izin_lingkungan'), "", "izin_lingkungan", ".png , .pdf , .jpg , .jpeg", false, true),
            'izin_komersial': new FileUploader($('#form_ipal').find('#izin_komersial'), "", "izin_komersial", ".png , .pdf , .jpg , .jpeg", false, true),
            'pernyataan': new FileUploader($('#form_ipal').find('#pernyataan'), "", "pernyataan", ".png , .pdf , .jpg , .jpeg", false, true),
            'persyaratan_teknis': new FileUploader($('#form_ipal').find('#persyaratan_teknis'), "", "persyaratan_teknis", ".png , .pdf , .jpg , .jpeg", false, true),
        }
        var swalLoading = {
            title: 'Harap Tunggu !',

  ...
  <div class="ibox ssection-container">
    <div class="ibox-content">
      <form class="form-inline" id="toolbar_form" onsubmit="return false;">
        ...
        <select class="form-control mr-sm-2" id="status_kasi" name="status_kasi">
          <option class="form-control mr-sm-2" value="all">Semua</option>
          <option class="form-control mr-sm-2" value="menunggu" selected>Menunggu Saya</option>
...
<script>
  $(document).ready(function() {
    ...
    toolbar.status_kasi.on('change', function() {
      getPengiriman();
    })
    ...
    toolbar.status_kasi.trigger('change');
    ...
    function renderPengiriman(data) {
      ...
      `;
        renderData.push([biro['id_pengiriman'], renderDate(biro['created_at']), biro['nama'] + (biro['nama_badan'] ? ('<br>' + biro['nama_badan']) : ''), biro['alamat'], biro['tujuan'] == 'usaha' ? "Usaha" : 'Umum', statusPermohonan(biro['status_proposal']), detailButton  ]);
      });

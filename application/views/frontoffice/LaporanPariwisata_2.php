              ...
              <div role="tabpanel" id="tab-1" class="tab-pane active">
                <div class="panel-body" id="input_modal2">
                  <form id="kebudayaan_form">
                    ...
                    <!-- <button class="btn btn-success my-1 mr-sm-2" type="submit" id="save_edit_btn2" data-loading-text="Loading..." onclick="this.form.target='edit'"><strong>Simpan Perubahan</strong></button> -->

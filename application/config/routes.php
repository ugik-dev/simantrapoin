...
$route['daftar'] = 'UserController/daftar';
$route['login/(:any)'] = 'UserController/login/$1';
...
$route['search/(:num)'] = 'PublicController/searchProcess/$1';
$route['search/(:num)/(:any)'] = 'PublicController/searchProcessID/$1/$2';
$route['searchdetail'] = 'PublicController/searchDetail';
$route['search'] = 'PublicController/search';
$route['detail_profile/(:num)/(:num)'] = 'UserTempController/ShowDetail/$1/$2';
